...
class ExercicioBibliotecaAmpliadaSeeder extends Seeder
{
    ...
    private static function linhas(): array
    {
        return [
            ...
            ['Rosca direta com halteres', 'Bíceps', 'Halteres', '7 reps na metade inferior, 7 na superior e 7 completas.'],
            ...
            ['Leg press horizontal', 'Pernas', 'Máquina', 'Uma perna por vez na plataforma inclinada.'],
            ...
            ['Agachamento sumô com barra', 'Pernas', 'Halter', 'Pés bem afastados e pontas para fora, halter entre as pernas.'],
            ...
            ['Stiff unilateral', 'Posterior', 'Halter', 'Quadril para trás sobre uma perna só, tronco e perna livre em linha.'],
            ['Good morning no smith', 'Posterior', 'Smith', 'Barra guiada nas costas, incline o tronco à frente com joelhos semiflexionados.'],
            ['Elevação pélvica solo unilateral', 'Glúteos', 'Peso corporal', 'Uma perna estendida no ar, eleve o quadril com a outra.'],
            ['Terra romeno com kettlebell', 'Posterior', 'Kettlebell', 'Quadril para trás com o kettlebell rente às pernas.'],
            ['Glúteo coice na polia', 'Glúteos', 'Polia', 'Tornozeleira na polia baixa, estenda o quadril para trás.'],
            ...
            ['Avanço com halteres', 'Pernas', 'Halteres', 'Passos longos e descida profunda enfatizam o glúteo.'],
            ['Agachamento búlgaro com foco em glúteo', 'Glúteos', 'Halteres', 'Tronco inclinado à frente desloca o estímulo para o glúteo.'],
            ['Subida no step com halter', 'Pernas', 'Halteres', 'Caixa alta e empurrão pelo calcanhar.'],
            ...
            ['Mountain climber', 'Core', 'Peso corporal', 'Na prancha, eleve uma perna por vez sem girar o quadril.'],
