...
$revisaoHugoMistos = [
    ...
    'Bicicleta ergométrica' => ['cena' => 'He rides a classic UPRIGHT STATIONARY EXERCISE BIKE: a padded saddle, FIXED handlebars that never move, pedals, and a solid enclosed flywheel housing at the front. It is NEVER an air bike: there is no large fan wheel, no cage of fan blades and no moving arm handles, and his arms never push or pull. He sits on the saddle with his hands resting on the fixed handlebars and pedals steadily, his legs going round in full circles while his upper body stays still. Filmed from the side. '.$academia],
];
