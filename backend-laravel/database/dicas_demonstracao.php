...
$revisaoHugoCore = [
    ...
    'Dead bug' => ['cena' => 'He lies flat on his back on the gym floor, lower back pressed into the ground, filmed from the SIDE. Both arms point straight UP at the ceiling and both knees are bent at a right angle, lifted, shins parallel to the floor, like a turned-over table. '.sprintf($duasPosicoes, 'both arms point straight up and both knees are bent at a right angle above his hips', 'his LEFT arm is stretched back overhead, hovering just above the floor behind his head, while at the same time his RIGHT leg is stretched out completely straight, hovering just above the floor; the right arm and the left leg stay exactly where they were').' The next repetition uses the opposite arm and leg. Only ONE arm and ONE leg move at a time, always opposite sides, and his back never lifts off the floor. His two arms NEVER move together, and his FEET NEVER rest on the floor: the bent legs stay lifted in the air, and the moving leg straightens out completely: its knee LOCKS straight and the heel travels far away from his buttocks until the whole leg lies long and low just above the floor, then it bends back up. The moving leg is never left bent at a right angle. It is never a sit-up or a crunch: his head and shoulders never curl up. '.$academia],
...
return array_replace($base, $maquinas, $outras, $complementar, $revisaoNumerada, $revisaoHugo, $revisaoHugoMaquinas, $terceiraPassada, $revisaoHugoHalteres, $revisaoHugoCorpo, $revisaoHugoCore, $revisaoHugoPolia);
