...
$base = [
    ...
    'Puxada frente' => $deFrenteProAparelho,
    ...
    'Tríceps banco livre com pés suspensos' => [
    ...
    'Tríceps unilateral na polia alta' => [
    ...
    'Puxada triângulo' => $deFrenteProAparelho,
...
$maquinas = [
    ...
    'Puxada triângulo' => ['cena' => 'He sits facing a lat pulldown machine, thighs locked under the pads. The attachment is one small solid metal TRIANGLE with two short parallel handles close together in the middle of it; he grips those two handles with palms facing each other. The triangle is a single rigid piece that keeps exactly the same shape in every frame and never splits into two separate bars. He pulls it straight down to the top of his chest. '.$caboUnico],
...
$outras = [
    ...
    'Abdominal supra máquina' => ['cena' => 'He sits in an abdominal crunch machine with a padded chest bar across the front of his chest and both hands gripping the handles beside his head. He crunches FORWARD, curling his ribs down toward his hips against the chest pad, then lets his torso come back up. The chest pad travels forward with him. '.$placaSobe],

    // Instrução da biblioteca é prescrição ("contraia 1s no topo"), que o
    // instrucaoVisual() descarta com razão — sobrava prompt sem movimento.
    'Elevação de quadril na máquina' => ['execucao' => 'Sentado na máquina de elevação pélvica, com a barra acolchoada sobre o quadril: suba o quadril até o corpo ficar reto e desça devagar.', 'cena' => 'He sits in a hip thrust machine with his upper back braced against a pad behind him, feet flat on a footplate in front, and a thick padded belt bar clamped down ACROSS HIS HIPS. He drives his HIPS upward against that hip pad until his torso and thighs form a straight line, then lowers them. The pad on his hips visibly rises and falls. '.$placaSobe],
...
$varreduraPreventiva = [
    ...
    'Abdominal pára-brisa suspenso na barra' => 'He hangs from a fixed bar overhead with both legs raised straight up in front of him, and swings the feet from one side to the other in a wide arc like a windscreen wiper while his hands stay fixed on the bar.',
...
// Lote 15, Equilíbrio: quatro alcances unipodais que só se distinguem pelo
// QUE alcança e PARA ONDE. Sem isso saem os quatro iguais — é o padrão de
// variante que já custou caro nos alongamentos.
$varreduraPreventiva['Marcha em linha (tandem)'] = 'He walks slowly FORWARD along a straight line painted on the gym floor, placing each foot directly in front of the other so the heel of the front foot touches the toes of the back foot at every step, arms held slightly out to the sides. His feet are never side by side.';
$varreduraPreventiva['Caminhada para trás em linha reta'] = 'He walks BACKWARDS along a straight line on the gym floor, moving away from the direction he is facing, setting the ball of each foot down first and then the heel, arms slightly out for balance. He never walks forward at any point.';
$varreduraPreventiva['Apoio unipodal com alcance frontal'] = 'He balances on ONE leg with that knee slightly bent, and reaches the FREE FOOT as far FORWARD as he can, tapping the floor lightly in front of him with the toes, then brings it back without putting weight on it. The reach is always straight ahead, never to the side.';
$varreduraPreventiva['Apoio unipodal com alcance multidirecional'] = 'He balances on ONE leg and reaches the FREE FOOT to tap the floor in THREE different directions in turn: straight ahead, then back and across behind the standing leg on the inside, then back and out to the far side. He returns to the middle between each reach and never puts weight on the free foot.';
$varreduraPreventiva['Apoio unipodal com alcance de objeto no solo'] = 'He balances on ONE leg and hinges his torso forward, reaching DOWN with his HAND to pick up a small object from the floor in front of him, while the free leg swings up behind him as a counterweight. He then stands back up still on the same single leg. The free foot never touches the ground.';
$varreduraPreventiva['Apoio unipodal com movimento de braços em três planos'] = 'He balances on ONE leg with the free foot lifted beside him and keeps the standing foot completely planted, while both ARMS move: first straight out in front, then out to the sides, then straight up overhead. Only the arms move; the legs and torso stay still.';

// Lote 16, fechando Equilíbrio.
$varreduraPreventiva['Salto frontal com aterrissagem em apoio único'] = 'He stands on TWO feet, jumps forward a short distance, and lands the jump on ONE single leg only, holding that landing still for a moment with the other foot lifted clear of the floor. The takeoff is on two feet; only the landing is on one leg.';
$varreduraPreventiva['Transferência de peso lateral controlada'] = 'He stands with feet planted wide apart, both feet flat on the floor the whole time, and slowly shifts his bodyweight from directly over one foot to directly over the other, bending that knee as the weight arrives. Neither foot ever lifts or steps; only the weight shifts side to side between the two planted feet.';
$varreduraPreventiva['Passada com pausa em apoio único'] = 'He steps forward into a lunge, then as he rises back up he pauses standing fully upright on the FRONT leg only, holding the back foot hovering off the floor for a moment before stepping it back down.';
$varreduraPreventiva['Elevação de joelho com equilíbrio e rotação'] = 'He balances on ONE leg and raises the other knee to hip height in front of him, then rotates his torso to swing that raised knee out to the side, and back to center, while the standing foot stays planted the whole time.';
$varreduraPreventiva['Cegonha com passagem de objeto'] = 'He balances on ONE leg with the other knee raised in front of him, like a stork. Holding a small object in both hands, he passes it under the raised knee from one hand to the other, then around behind his back to pass it under again. The raised foot never touches the floor.';
$varreduraPreventiva['Equilíbrio dinâmico em agachamento com transferência de peso'] = 'He holds a half-squat position, knees bent and hips down, and stays in that half-squat height the whole time while shifting his weight from one foot to the other, side to side. He never stands up between shifts and never lifts a foot off the floor.';
$varreduraPreventiva['Deslocamento sobre linha com obstáculos baixos'] = 'He walks forward along a straight line on the floor, and every couple of steps lifts one foot high to step OVER a small low obstacle placed on the line, alternating which foot leads, before continuing to walk the line.';

// Lote 17, abrindo Ativação: os "sem carga"/"sem equipamento" precisam
// negar a barra/peso que o gerador tende a colocar por padrão numa cena de
// academia.
$varreduraPreventiva['Flexão escapular (scapular push-up)'] = 'He is in a high plank on straight arms, hands under shoulders. Without bending the elbows at all, he lets his upper back sag between his shoulder blades, then pushes the floor away to round his upper back and spread the shoulder blades apart. The elbows stay completely locked straight the whole time — this is not a push-up, the arms never bend.';
$varreduraPreventiva['Retração escapular na polia baixa sentado'] = 'He sits facing a low pulley, arms straight out in front holding the handle. Without bending the elbows at all, he pulls his shoulder blades back and together so the handle moves a few centimetres toward him, then releases. The elbows stay locked straight throughout — this is not a rowing motion, the arms never bend.';
$varreduraPreventiva['Ativação de core com respiração 360 graus'] = 'He lies FACE UP on the floor with knees bent, both hands resting on the sides of his lower ribs. He breathes in, expanding his ribs sideways into his own hands and slightly into the floor behind him, not lifting his chest upward. He holds this position still, only the breathing moves.';
$varreduraPreventiva['Aquecimento articular de ombros com círculos'] = 'He stands with both arms straight out to the sides at shoulder height, and draws small circles with his hands that grow larger with each repetition. His arms stay straight and at shoulder height the whole time; they never come down to his sides and never go overhead.';
$varreduraPreventiva['Aquecimento de quadril com círculos em pé'] = 'He stands with both hands on his hips and draws large slow circles with his hips, the knees staying soft, without his feet moving from the spot.';
$varreduraPreventiva['Polichinelo com abertura de braços em Y'] = 'He jumps feet apart while sweeping both arms up into a wide diagonal V shape above his head, like the letter Y — the arms stop at the diagonal, well short of straight overhead, and never touch above his head like a normal jumping jack. He jumps his feet back together as the arms come back down.';
$varreduraPreventiva['Corrida no lugar com toque de calcanhar lateral'] = 'He jogs in place, and on each step kicks that heel out and back so it taps the hand on the SAME side held out low beside his hip — the heel comes up and out to the side, never straight up behind him toward the glute.';
$varreduraPreventiva['Aquecimento de punhos e dedos'] = 'He stands and repeatedly opens both hands wide, spreading the fingers, then closes them into fists, and also slowly circles both wrists in one direction and then the other.';
$varreduraPreventiva['Aquecimento específico com barra vazia'] = 'He holds an empty barbell (no weight plates on either end) across the front of his shoulders or in front of his hips, and performs a slow, unloaded squat, standing back up. The bar is always empty, with bare metal visible past his hands on both sides.';
$varreduraPreventiva['Aquecimento de ombro com halteres leves em três planos'] = 'He holds a small light dumbbell in each hand and performs three raises in sequence: first both arms straight out in FRONT of him to shoulder height, then both arms out to the SIDES to shoulder height, then both arms raised on a forward DIAGONAL between the two. Each raise returns to his sides before the next begins.';
$varreduraPreventiva['Ativação de peitoral com isometria de palmas'] = 'He stands with both palms pressed flat together at chest height, elbows out to the sides, and pushes one palm hard against the other without either hand moving, holding the press. He holds this position still: it is an isometric hold, not a repeated movement.';
$varreduraPreventiva['Aquecimento de coluna com rotações em pé'] = 'He stands with feet planted and arms hanging loose and relaxed at his sides, and rotates his torso from side to side, letting the loose arms swing and lightly wrap around his body with the momentum.';
// Reescrita depois de 2 tentativas idênticas renderizarem um agachamento
// lento único em vez de pulsos — precisou afirmar a profundidade já no
// primeiro frame e proibir explicitamente o "ficar em pé"/"descer completo".
$varreduraPreventiva['Ativação de quadril com agachamento pulsado'] = 'In the very first frame he is already at half-squat depth, knees bent about 90 degrees. For the rest of the clip his hips barely move — only a tiny few-centimeter bounce, up and down, up and down, fast and small, like a gentle vibration. This is NOT a single slow squat down or a single squat up: he never straightens his legs to standing at any point, and he never drops lower into a deep squat at any point.';
$varreduraPreventiva['Marcha de ativação com elástico nos tornozelos'] = 'A single continuous elastic resistance band loops around both his ankles and stays clearly visible connecting them in every single frame; there is never a second band and it never turns into a rope, cable or chain. Standing in one spot without traveling forward or sideways, he marches by lifting one knee up high in front of him against the band resistance, sets that foot back down, then lifts the other knee — he stays planted in the same spot the whole time, this is marching in place, not walking across the floor.';
$varreduraPreventiva['Bom dia sem carga para aquecimento'] = 'He stands with both hands laced behind his head, elbows out wide, and hinges forward from the hips with a straight back until his torso is close to horizontal, then stands back up. His hands stay empty behind his head the whole time — there is no bar and no weight anywhere in the shot.';
$varreduraPreventiva['Aquecimento de quadril em passada com rotação torácica'] = 'He steps into a forward lunge, and at the bottom of each lunge rotates his torso toward the side of the front leg, then rotates back to center before stepping the feet back together and lunging with the other leg.';
$varreduraPreventiva['Aquecimento de joelho com extensão sentado sem carga'] = 'He sits on the edge of a bench with his back straight, and slowly extends one knee straight out in front of him until the leg is level, then lowers it back down. His hands rest empty on the bench or his thighs — there is no ankle weight, no machine pad and no added resistance anywhere in the shot.';
$varreduraPreventiva['Aquecimento de tronco com rotação e toque no pé'] = 'He stands with feet wide apart, and bends down rotating his torso to touch one hand to the opposite foot, then stands back up and repeats touching the other hand to the other foot.';

// Lote 19, reforço de musculação e hipertrofia: 12 exercícios sem cena
// nenhuma (o dry-run confirmou — prompt saía só com o nome, sem frase de
...
$varreduraPreventiva['Man maker com halteres'] = 'He holds one dumbbell in each hand the whole time. From a plank position with a dumbbell under each hand, he rows one dumbbell up to his ribs and sets it down, then rows the other dumbbell up and sets it down, then jumps his feet forward outside his hands and stands up, pressing both dumbbells straight overhead.';
$varreduraPreventiva['Corrida de vai e vem (shuttle run)'] = 'He sprints forward from a start line to a marked point on the floor, bends down to touch that point with one hand, then immediately sprints back the way he came to the start line — a clear touch-and-return sprint, not a straight continuous run in one direction.';
// Front lever e back lever tinham só a linha em português do
// $execucaoComplementar (linha 797/798) — sem cena em inglês nenhuma, o
...
// deslocamento/agilidade — o risco maior aqui não é objeto errado (poucos
// props no grupo), é o gerador substituir o padrão específico descrito por
// "correr genérico" ou "pular genérico", que é o mesmo problema visto no
// "Corrida no lugar com toque de calcanhar lateral" do lote 18.
$varreduraPreventiva['Aceleração de 5 metros com mudança de direção'] = 'He sprints forward five quick steps, then plants one foot hard and immediately drives off explosively in the exact opposite direction, sprinting back the way he came. This is a sharp direction change, not a stop-and-turn: he never comes to a full standing stop before reversing.';
$varreduraPreventiva['Agachamento em base de surf com rotação'] = 'He stands in a wide sideways surf stance, knees bent low, one shoulder pointing forward like standing on a surfboard. He squats down deeper and rotates his torso to face one side, then rotates to face the other side while staying low in the squat the whole time.';
$varreduraPreventiva['Arremesso acima da cabeça com medicine ball'] = 'He holds a medicine ball with both hands above and behind his head, then extends his whole body — hips, torso and shoulders — to throw the ball hard forward and down onto the floor in front of him, releasing it from overhead. The ball leaves his hands every rep; he never just holds it.';
$varreduraPreventiva['Aterrissagem de salto em profundidade (drop jump)'] = 'He starts standing on top of a low box. He steps off the box and drops to the floor, landing on both feet with soft bent knees, and the instant his feet touch the ground he jumps straight up into the air. He never jumps forward off the box, only steps off and drops down.';
$varreduraPreventiva['Bloqueio duplo com salto lateral'] = 'He takes two quick sideways shuffle steps in the same direction, feet never crossing, then jumps straight up with both arms reaching overhead as if blocking above a net. He lands back on both feet in the new spot.';
$varreduraPreventiva['Condução de bola em ziguezague'] = 'A single soccer ball stays in contact with his feet the whole clip, never far from him and never disappearing from frame. He dribbles it forward weaving in a zigzag path, touching it alternately with the inside of each foot to change direction, never picking it up with his hands.';
...
$varreduraPreventiva['Golpe reto com halteres leves'] = 'He holds one small light dumbbell in each hand up near his chin in a boxing guard, and throws alternating straight punches forward from his chin, rotating his rear foot and hip with each punch, then pulling the hand straight back to his chin before the next punch.';
$varreduraPreventiva['Levantada técnica (technical stand-up)'] = 'He starts sitting on the floor in a defensive posture, one hand and the opposite foot planted on the ground, free arm up guarding in front of his face. He pushes up off that hand and foot to stand up, keeping the guarding arm up the whole time, ending standing.';
$varreduraPreventiva['Marcha atlética no plano'] = 'He walks forward briskly with exaggerated hip rotation each stride, but at least one foot always stays in contact with the floor at every moment — he never has both feet off the ground at once, this is walking, not running or jogging.';
$varreduraPreventiva['Passada saltada (bounding)'] = 'He runs forward taking exaggerated long bounding strides, pushing off the ground hard with each step to get real hang time in the air between landings, covering much more ground per stride than a normal run.';
$varreduraPreventiva['Passo cruzado para a rede'] = 'He steps his back foot forward and across in front of his other leg — a clear crossover step — then continues advancing diagonally forward in the direction he crossed toward.';
$varreduraPreventiva['Pedalada em cadência alta na bicicleta'] = 'He sits on the seat of a stationary exercise bike, hands on the handlebars, and pedals both legs in fast smooth circles with light resistance. His hips stay planted on the seat and never bounce up off it.';
...
$varreduraPreventiva['Salto alternado em profundidade'] = 'He starts standing on top of a low box. He steps off and drops to the floor, and lands the drop on ONE single leg only, immediately hopping back up onto the box on that same leg, then repeats stepping off and landing on the other leg the next time.';
$varreduraPreventiva['Salto contínuo com joelhos ao peito'] = 'He jumps repeatedly on the spot, and on each jump pulls both knees up high toward his chest at the peak of the jump, landing softly on both feet for only an instant before jumping again — continuous rapid jumps, not single isolated jumps with a pause between.';
$varreduraPreventiva['Salto de cabeceio com aterrissagem'] = 'He dips down into a quick quarter-squat, then explodes straight upward into a vertical jump reaching one hand up as if heading a ball, and lands back down on both feet with soft bent knees absorbing the landing.';
$varreduraPreventiva['Salto lateral sobre linha com aterrissagem em apoio único'] = 'There is a straight line on the floor. He jumps sideways over the line, landing the jump on ONE single leg only on the other side, and holds that one-leg landing still and balanced for a moment before the next rep. He never lands on two feet.';
$varreduraPreventiva['Salto vertical com contramovimento e alcance'] = 'He quickly dips down into a quarter-squat, swinging both arms back, then immediately explodes upward into a maximal vertical jump, reaching one hand as high as possible overhead at the peak, before landing back down.';
$varreduraPreventiva['Saque de tênis com medicine ball'] = 'He holds a medicine ball with both hands overhead behind his head, arches back slightly, then throws the whole body forward and up, releasing the ball forward and downward from overhead like a tennis serve. The ball leaves his hands every rep.';
$varreduraPreventiva['Split step com salto'] = 'He makes a small quick hop straight up with feet together, and lands the hop with his feet apart in a wide athletic stance, knees bent, weight balanced and ready to push off to either side.';
$varreduraPreventiva['Sprawl'] = 'He starts crouched low in a wrestling stance, hands forward. He throws both legs backward explosively, dropping his hips down so his whole body lands flat in a plank/push-up position, chest low. He then pushes back up explosively to his feet, returning to the crouched stance.';
$varreduraPreventiva['Suspensão em pegada aberta para escalada'] = 'He hangs by both hands from a wall-mounted climbing hold or fingerboard edge, fingers spread in an open-hand grip rather than a closed fist, feet off the floor, shoulders pulled down and active. He holds this position still: it is an isometric hold, not a repeated movement.';
$varreduraPreventiva['Sustentação de tronco em posição aero'] = 'He is in a forearm plank, both forearms flat on the floor under his shoulders, hips lifted slightly higher than a normal plank and back flat, like leaning over aerodynamic bicycle handlebars. He holds this position still: it is an isometric hold, not a repeated movement.';
$varreduraPreventiva['Tiro em subida na rampa'] = 'He sprints forward up a visibly inclined ramp or slope, his torso leaning forward into the incline and his arms pumping hard, clearly running uphill rather than on flat ground.';
$varreduraPreventiva['Tiro sentado com carga alta na bicicleta'] = 'He stays seated on the bike saddle the whole time — his hips never lift off the seat — and pedals slowly and powerfully against heavy resistance, torso braced and steady over the handlebars.';
$varreduraPreventiva['Tríceps de finalização de braçada na polia'] = 'He leans his torso forward, holding a cable pulley handle with his elbow bent at his side. He extends his elbow straight to push the handle backward past his hip, like finishing a swimming stroke, then lets it return.';
...
// ---------------------------------------------------------------------------
// Revisão do Hugo, 16/09/2026 — família MÁQUINA (lote 2 de 12)
//
// Tira de 3 frames dos 12 vídeos em produção antes de escrever. O padrão desta
// família NÃO é o da polia:
//
//  (a) AMPLITUDE ZERO em 8 dos 12 — o sujeito senta na máquina e os três frames
//      saem idênticos. Daí o $duasPosicoes em todos, que foi o que deu amplitude
//      no lote da polia.
//  (b) IDENTIDADE DE MÁQUINA em 4: o tríceps na máquina saiu numa máquina de
//      ROSCA (pad de scott sob os braços); a elevação de quadril saiu com BARRA
//      nos quadris no chão em vez da máquina; a mesa flexora saiu com o rolo nas
//      COSTAS em vez de atrás dos tornozelos; a extensão lombar virou máquina de
//      abdominal. Mesma receita que resolveu corda e barra V: descrever a peça
//      pelo CONTATO com o corpo e negar por nome a máquina que apareceu.
$revisaoHugoMaquinas = [

    'Supino máquina' => ['cena' => 'He sits on a chest press machine with his back flat against the upright backrest, gripping one horizontal handle on each side at chest height, filmed from a three-quarter FRONT angle so the forward push of his hands is clearly visible. At the start his elbows are bent to a right angle and pulled BACK behind the line of his torso, and each hand is right beside his armpit: his arms are NEVER stretched out wide and straight to the sides like wings. '.sprintf($duasPosicoes, 'both elbows are bent and pulled back so his hands are beside his ribs and the handles are close to his chest', 'both arms are completely straight out in FRONT of his chest, elbows locked, handles pushed far away from his body').' His hands travel forward and back along a horizontal line in front of his chest. It is never a pec deck: his arms never open out sideways in a wide arc, and his hands never go out beyond the line of his shoulders. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Extensão lombar na máquina' => ['cena' => 'He sits in a BACK EXTENSION machine: his lower back and shoulder blades rest against a padded backrest that pivots BEHIND him, his shins are locked under a padded roller in front, and a belt crosses his lap. His arms are folded across his chest and stay there. '.sprintf($duasPosicoes, 'his torso is upright and vertical, chest tall', 'his torso has leaned far BACKWARD, pushing the backrest behind him until his body is reclined well past vertical, chest pointing up at the ceiling').' The movement happens at his hips and lower back only. He never curls FORWARD toward his knees, and this is never an abdominal crunch machine. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Remada aberta máquina' => ['execucao' => 'Remada aberta na máquina: peito apoiado no pad, puxe os cotovelos abertos para trás até a linha do tronco.', 'cena' => 'He sits at a seated ROW machine with his chest pressed against a vertical padded chest support in front of him, holding one horizontal handle on each side in a WIDE grip, hands wider than his shoulders. '.sprintf($duasPosicoes, 'both arms are stretched straight out FORWARD in front of his chest, shoulders reaching forward', 'both elbows are pulled far BACK and OUT to the sides at shoulder height, hands level with his ribs and shoulder blades squeezed together').' His chest never leaves the pad and his torso never swings backward. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Desenvolvimento na máquina' => ['cena' => 'He sits in a SHOULDER PRESS machine with his back against an upright backrest, gripping one vertical handle on each side. The handles start level with his ears, not in front of his chest. '.sprintf($duasPosicoes, 'both elbows are bent and pointing down and out, hands level with his ears on each side of his head', 'both arms are completely straight UP above his head, hands high over his skull, elbows locked').' The handles travel straight up and down in a vertical line beside his head. They never travel forward in front of his chest: this is never a chest press and never a pec deck. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Tríceps testa na máquina' => ['cena' => 'He sits at a TRICEPS EXTENSION machine. The back of his upper arms rest flat on a horizontal pad in front of him with the elbows on top of that pad, and both hands grip a handle up near his forehead. '.sprintf($duasPosicoes, 'both elbows are folded shut so his hands are up beside his forehead, forearms pointing back toward his face', 'both elbows are completely straight so his hands are pushed far away and down, arms extended in one straight line').' Only the forearms move; the upper arms never lift off the pad. It is never a biceps curl machine: his hands never travel UP toward his shoulders, and the movement is his hands going AWAY from his head, never toward it. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    // Mesmo caso: "pausa de 1s na contração" não descreve movimento nenhum.
    'Cadeira extensora unilateral' => ['execucao' => 'Sentado na cadeira extensora, uma perna de cada vez: estenda o joelho até a perna ficar reta à frente e volte devagar.', 'cena' => 'He sits in a LEG EXTENSION machine with his back against the backrest, hands holding the side grips. Only ONE leg works: a padded roller rests across the front of that ankle, and the OTHER leg hangs relaxed and completely still beside the machine, its foot off the roller the whole time. '.sprintf($duasPosicoes, 'the working knee is bent so that shin hangs straight DOWN toward the floor, vertical', 'the working knee is completely straight so that shin is HORIZONTAL and parallel to the floor, the foot lifted high in front of him').' The roller stays on the front of the shin, just above the foot, and never touches the back of his leg. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Flexora em pé na máquina' => ['cena' => 'He STANDS upright at a standing leg curl machine, chest and hips braced against a vertical pad, both hands holding the handles in front of him. A padded roller sits against the BACK of one ankle, behind the Achilles tendon, never in front of the shin. '.sprintf($duasPosicoes, 'the working leg is straight down, foot on or near the floor, knee unbent', 'the working knee is folded shut so the heel is pulled UP behind him toward his buttock, shin roughly parallel to the floor').' Only that knee bends: his hips stay still against the pad and he never leans forward. The other foot stays flat on the floor. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Mesa flexora' => ['cena' => 'He lies FACE DOWN and flat along a lying leg curl bench, hips on the bench and both hands gripping the handles under the front edge. A padded roller rests across the BACK of both ankles, just above his heels. Nothing rests on his back, his shoulders or his waist: no pad and no roller ever touches his upper body. '.sprintf($duasPosicoes, 'both legs are stretched out completely straight behind him, in line with his body', 'both knees are folded shut so both heels are pulled UP toward his buttocks, shins close to vertical').' Only the knees bend; his hips stay pressed on the bench. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    // Instrução da biblioteca é prescrição ("contraia 1s no topo"), que o
    // instrucaoVisual() descarta com razão — sobrava prompt sem movimento.
    'Elevação de quadril na máquina' => ['execucao' => 'Sentado na máquina de elevação pélvica, com a barra acolchoada sobre o quadril: suba o quadril até o corpo ficar reto e desça devagar.', 'cena' => 'He sits in a dedicated HIP THRUST MACHINE: his upper back rests against a fixed padded backrest, his feet are flat on a raised footplate in front of him, and a wide padded lap bar presses down across the front of his hips, held by the machine frame on both sides. There is no barbell anywhere in the shot and he is never sitting on the floor. '.sprintf($duasPosicoes, 'his hips are dropped LOW, close to the seat, knees bent and the lap bar down at its lowest point', 'his hips are driven UP high so that his thighs and torso form one straight horizontal line, glutes squeezed and the lap bar lifted').' Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Panturrilha no leg press' => ['cena' => 'He sits in a 45 degree leg press machine with both legs already STRAIGHT and locked, knees unbent for the whole clip. Only the BALLS of his feet are on the very bottom edge of the footplate, and both heels hang off the edge into empty air. '.sprintf($duasPosicoes, 'both ankles are flexed so the heels drop far BELOW the bottom edge of the plate and the toes are pulled toward his shins, a deep stretch', 'both ankles are fully pointed so the heels are pushed HIGH above the toes and he is up on the balls of his feet, calves bunched').' The knees never bend and the only joint that moves is the ankle. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Panturrilha unilateral no leg press' => ['cena' => 'He sits in a 45 degree leg press machine with ONE leg straight and locked, only the ball of that foot on the very bottom edge of the footplate and that heel hanging off the edge into empty air. The other foot is off the plate entirely, resting to the side, still. '.sprintf($duasPosicoes, 'that ankle is flexed so the heel drops far BELOW the bottom edge of the plate, toes pulled toward the shin', 'that ankle is fully pointed so the heel is pushed HIGH above the toes, calf bunched').' The knee never bends and the only joint that moves is that ankle. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],

    'Abdominal supra máquina' => ['cena' => 'He sits in an ABDOMINAL CRUNCH machine, hands gripping the handles beside his head and a padded bar resting on his chest and shoulders, feet hooked under the foot pads. '.sprintf($duasPosicoes, 'his torso is upright and tall, back against the pad, the chest bar at its highest point', 'his torso is curled FORWARD and down, spine rounded, chest driven toward his knees and the chest bar pushed far down in front of him').' The movement is his ribcage folding toward his pelvis. He never leans backward and never stays sitting upright and motionless. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],
];
...
$terceiraPassada = [
    ...
    'Panturrilha no leg press' => ['cena' => 'He sits low and reclined in the seat of a 45 DEGREE LEG PRESS SLED: two long diagonal steel rails run up away from him, and a big angled footplate loaded with stacked weight plates sits high above his feet on those rails. The whole machine is above and in front of him, and he is looking up at the plate. It is never a leg extension chair and never a seated bench. From hip to toe each leg is ONE RIGID COLUMN: thigh and shin form a single unbroken straight line, knees locked out completely, and they stay exactly like that in every frame. He is not pressing anything with his legs and his legs do not move at all — the knees never bend even slightly. Only the BALLS of his feet are on the very bottom edge of the footplate; both heels hang off the edge over empty air. The only joint that moves in the entire clip is the ANKLE, and its movement is made obvious by two big things that travel with it: the loaded footplate visibly slides UP and DOWN along the two diagonal rails, and his whole body is pushed further away from the seat and then settles back. '.sprintf($duasPosicoes, 'both heels have dropped far DOWN below the bottom edge of the plate, toes pulled back toward the shins, calves stretched long', 'both heels are pushed far UP above the toes, so he is high on the balls of his feet and the calf muscles are bunched into a hard ball').' Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],
    ...
    'Panturrilha unilateral no leg press' => ['cena' => 'He sits low and reclined in the seat of a 45 DEGREE LEG PRESS SLED: two long diagonal steel rails run up away from him, and a big angled footplate loaded with stacked weight plates sits high above his feet on those rails. It is never a leg extension chair and never a seated bench. His LEFT foot is not on the machine at all: it rests flat on the FLOOR beside the seat, clearly visible on the ground, and it stays there doing nothing the whole time. Only the RIGHT leg is on the plate, and from hip to toe it is ONE RIGID COLUMN: thigh and shin in a single unbroken straight line, knee locked out, never bending even slightly. Only the BALL of the right foot is on the very bottom edge of the footplate, with that heel hanging off the edge over empty air. The only joint that moves in the entire clip is that right ANKLE, and its movement is made obvious by two big things that travel with it: the loaded footplate visibly slides UP and DOWN along the two diagonal rails, and his whole body is pushed further away from the seat and then settles back. '.sprintf($duasPosicoes, 'the right heel has dropped far DOWN below the bottom edge of the plate, toes pulled back toward the shin', 'the right heel is pushed far UP above the toes, high on the ball of the foot, calf bunched').' Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],
    ...
    'Remada aberta máquina' => ['execucao' => 'Remada aberta na máquina: peito apoiado no pad, puxe os cotovelos abertos para trás até passarem da linha do tronco.', 'cena' => 'He sits at a seated ROW machine with his chest pressed against a vertical padded chest support, holding one horizontal handle on each side in a WIDE grip, hands wider than his shoulders. The machine is a SEATED ROW: he faces a vertical padded chest support, the handles come toward his belly on a horizontal line, and the weight stack is in front of him beyond the pad. It is never a pec deck and never a rear delt machine: his arms never open out sideways in a wide arc at shoulder height, and his hands never end up out to the sides of his body. The handles travel a long way: the distance between the two positions is as long as his own forearm. '.sprintf($duasPosicoes, 'both arms are stretched out completely straight FORWARD, elbows locked, shoulders reaching forward and the hands far away from his chest', 'both elbows are bent past a right angle and drawn back close along his sides until the hands are beside his ribs, the elbows pointing back behind him and the shoulder blades squeezed together').' His chest never leaves the pad. Behind him is a busy gym floor with other weight machines, racks and dumbbells clearly visible.'],
...
// ---------------------------------------------------------------------------
// Revisão do Hugo, 16/09/2026 — família HALTERES (lote 3 de 12)
//
// Tira de 3 frames dos 12 antes de escrever. Cinco padrões, nenhum igual aos
// lotes anteriores:
//  (a) CRUCIFIXO SAINDO COMO SUPINO nos três (7, 8, 11): o cotovelo dobra e o
//      halter sobe em linha reta. Negado por nome, e o cotovelo declarado quase
//      travado.
//  (b) ÂNGULO DO BANCO (11, 36, 153, 168). "Declinado", "inclinado" e "reto" são
//      abstrações; o banco agora é descrito por QUAL PONTA ESTÁ MAIS ALTA.
//  (c) PEGADA NEUTRA virando supinada (162, 163). Descrita pela orientação do
//      OBJETO — o halter em pé, anilhas uma sobre a outra — que foi o que
//      resolveu corda e barra nos lotes anteriores.
//  (d) AMPLITUDE (90, 184, 190): $duasPosicoes, como no lote 2.
//  (e) Quatro saíram em corredor branco vazio, contra a regra do catálogo.
$semPress = 'It is never a bench press: his elbows never fold to a right angle, the dumbbells never travel straight UP and DOWN above his chest, and they never meet over the middle of his chest by bending the arms.';
$arcoAberto = 'Both elbows stay almost completely straight the whole time, with only a soft unlocked bend that never changes. The dumbbells travel in a WIDE ARC out to the sides, like slow wings opening and closing, and the whole movement happens out at the sides of his body.';
$halterEmPe = 'Each dumbbell stays VERTICAL the whole time, standing upright like a bottle, with its two weight plates one directly ABOVE the other, and his palms face each other toward the midline of his body. The dumbbells never rotate to lie horizontal and the two plates never end up side by side.';

$revisaoHugoHalteres = [

    'Crucifixo declinado com halteres' => ['cena' => 'He lies on a bench tilted so that his HEAD is LOWER than his hips, with his feet hooked at the raised end up near his knees, a dumbbell in each hand. '.$arcoAberto.' '.sprintf($duasPosicoes, 'both arms are opened out WIDE to the sides, the dumbbells level with his shoulders and out beyond the edges of the bench, chest stretched open', 'the two dumbbells have come together directly above the middle of his chest with the arms still almost straight, the two dumbbells nearly touching').' '.$semPress.' '.$academia],

    'Crucifixo inclinado com halteres' => ['cena' => 'He lies back on a bench tilted so that his HEAD is HIGHER than his hips, chest facing up and slightly forward, a dumbbell in each hand. '.$arcoAberto.' '.sprintf($duasPosicoes, 'both arms are opened out WIDE to the sides, the dumbbells level with his shoulders and out beyond the edges of the bench, chest stretched open', 'the two dumbbells have come together above the upper part of his chest with the arms still almost straight, the two dumbbells nearly touching').' '.$semPress.' '.$academia],

    'Crucifixo reto' => ['cena' => 'He lies on a FLAT bench: its surface is perfectly horizontal and parallel to the floor, both ends at exactly the same height, with no part of it tilted up or down. His head, shoulders and hips are all at the same level, and both feet are flat on the floor. He holds a dumbbell in each hand. '.$arcoAberto.' '.sprintf($duasPosicoes, 'both arms are opened out WIDE to the sides, the dumbbells level with his shoulders and out beyond the edges of the bench, chest stretched open', 'the two dumbbells have come together directly above the middle of his chest with the arms still almost straight, the two dumbbells nearly touching').' '.$semPress.' '.$academia],

    'Supino declinado com halteres' => ['cena' => 'He lies on a bench tilted so that his HEAD is clearly LOWER than his hips and his feet are hooked at the raised end near his knees: the bench slopes downward from feet to head. It is never a flat bench and never tilted the other way with the head high. He holds a dumbbell in each hand. '.sprintf($duasPosicoes, 'both elbows are bent and dropped low so the dumbbells are beside his lower chest, level with his ribs', 'both arms are pushed completely straight, the dumbbells high above his lower chest, elbows locked').' '.$academia],

    'Levantamento terra com halteres' => ['cena' => 'He stands with a dumbbell hanging in each hand in front of his thighs. The movement is a HINGE AT THE HIPS, not a squat: his hips travel BACKWARD behind his heels and his back stays long and flat, while the knees stay only softly bent and barely change angle. '.sprintf($duasPosicoes, 'he stands tall and upright, shoulders back, dumbbells hanging against the front of his thighs', 'his hips have pushed far back and his torso has folded forward to almost parallel with the floor, the dumbbells hanging down past his knees close to his shins, back flat').' His knees never travel forward over his toes and he never drops straight down into a squat. '.$academia],

    'Remada curvada com halteres' => ['cena' => 'He holds a dumbbell in each hand, filmed from the SIDE so his whole body is seen in profile. He is bent far FORWARD at the hips and stays there the whole clip: the chest faces the FLOOR, the shoulders are clearly LOWER than the hips, the back is flat like a table top and the head points forward, out over his toes. He is NEVER standing upright, the chest never faces the camera, and the torso never rises during the movement. '.sprintf($duasPosicoes, 'both arms hang straight DOWN toward the floor, elbows completely open, the dumbbells below his chest', 'both elbows are pulled high and BACK past the line of his ribs, the dumbbells right beside his waist and the shoulder blades squeezed together').' Only the arms move. '.$academia],

    'Rosca de bíceps sentado com halteres' => ['execucao' => 'Sentado num banco com o encosto na vertical, costas apoiadas: flexione os cotovelos até a altura dos ombros e volte devagar.', 'cena' => 'He sits on a bench with a tall padded BACKREST that rises straight UP behind his spine like a small wall, standing vertical from the seat to above his shoulder blades. That backrest is a big dark rectangle clearly visible behind his torso in every single frame, and his shoulder blades and lower back are pressed flat against it so his torso is bolt upright. There is never empty air behind his back: it is never a flat bench with nothing behind him, and the backrest is never tilted back like a deckchair. A dumbbell hangs in each hand beside the bench. '.sprintf($duasPosicoes, 'both arms hang straight DOWN beside his hips, elbows completely open, dumbbells low', 'both elbows are folded shut so the dumbbells are up at the front of his shoulders').' His upper arms stay beside his ribs and never swing forward. '.$academia],

    'Rosca martelo com halteres' => ['cena' => 'He stands upright with a dumbbell in each hand. '.$halterEmPe.' '.sprintf($duasPosicoes, 'both arms hang straight DOWN beside his thighs, elbows open, dumbbells vertical beside his legs', 'both elbows are folded shut so the dumbbells are up at the front of his shoulders, still vertical, thumbs on top').' Both dumbbells move at the same time. His upper arms stay pinned beside his ribs. '.$academia],

    'Rosca martelo alternada' => ['cena' => 'He stands upright with a dumbbell in each hand. '.$halterEmPe.' He alternates: while one elbow folds and lifts its dumbbell to the front of that shoulder, the other arm hangs completely straight down beside his thigh, and then they swap. The two dumbbells are never at the same height at the same time. Both stay vertical through the whole movement, including at the top. His upper arms stay pinned beside his ribs. '.$academia],

    'Rosca Scott com halter unilateral' => ['cena' => 'He stands behind a PREACHER BENCH: a thick pad angled steeply downward in front of him, like a lectern. The back of his working upper arm lies flat along that angled pad from armpit to elbow and never lifts off it, with his armpit pressed against the top edge of the pad. He holds one dumbbell in that hand; the other hand rests on the top of the pad. '.sprintf($duasPosicoes, 'that elbow is completely open so the forearm points down along the pad and the dumbbell is at the bottom, arm almost straight', 'that elbow is folded shut so the dumbbell is up near his own shoulder').' '.$academia],

    'Tríceps coice com halter' => ['cena' => 'He bends forward at the hips until his torso is almost parallel to the floor, one hand braced on a bench, one dumbbell in the other hand. That working upper arm is glued against his ribs and points BACKWARD, parallel to the floor, and it never moves. '.sprintf($duasPosicoes, 'the forearm hangs straight DOWN toward the floor at a right angle to the upper arm, the dumbbell directly under the elbow', 'the elbow is completely straight so the whole arm is one straight horizontal line pointing back behind his hip, the dumbbell the furthest thing behind him').' The forearm never swings forward under his chest. '.$academia],

    'Tríceps francês sentado com halter' => ['cena' => 'He sits upright on a bench holding ONE single dumbbell with BOTH hands together: his two palms are cupped flat under the TOP plate of the dumbbell, fingers interlocked around the handle, and the dumbbell hangs vertically below his hands. Both elbows point straight UP at the ceiling and stay close beside his head, and they never flare out sideways. '.sprintf($duasPosicoes, 'both elbows are folded shut so the dumbbell hangs low BEHIND his head, down between his shoulder blades', 'both arms are pushed completely straight UP so the dumbbell is high above the top of his head, elbows locked').' '.$academia],
];

// ---------------------------------------------------------------------------
// Revisão do Hugo, 16/09/2026 — família PESO CORPORAL (lote 4 de 12)
//
// Tira de 3 frames dos 12 antes de escrever. O padrão dominante voltou a ser o
// da família máquina: AMPLITUDE ZERO em 6 dos 12 (agachamento, ponte, mergulho,
// panturrilha no step) — o sujeito fica em pé parado. Daí $duasPosicoes em
// quase todos. Os outros erros são de APOIO (onde o corpo encosta) e um de
// pegada. Apoio descrito por CONTATO, como no lote de máquinas.
$revisaoHugoCorpo = [

    'Flexão de braço' => ['cena' => 'He is in a push-up position on the gym floor, hands flat under his shoulders, body in one straight rigid line from heels to head with the hips never sagging or rising. '.sprintf($duasPosicoes, 'both arms are completely straight, elbows locked, the body high and far off the floor', 'both elbows are bent deep so his chest is almost touching the floor, only a fist of space left under his sternum').' It is a deep, obvious travel, never a small bounce near the top. '.$academia],

    'Barra fixa pegada supinada (chin-up)' => ['cena' => 'He hangs from a fixed horizontal PULL-UP BAR high above him, feet off the floor. His grip is UNDERHAND: both palms face HIS OWN FACE. Because the camera is in front of him, it therefore sees the BACKS of both hands and the knuckles, and the face of his wristwatch on the back of his wrist, while his fingertips are hidden, curled over the bar toward the far side; the thumbs point OUTWARD, away from each other. The camera never sees his open palms or his fingernails curling over the bar toward the lens — that would be an overhand pull-up. At the top his chin clearly rises ABOVE the bar. '.sprintf($duasPosicoes, 'both arms are completely straight, hanging at full stretch with the shoulders pulled up beside his ears', 'both elbows are folded shut and his CHIN is above the level of the bar, chest close to it, elbows pointing down beside his ribs').' '.$academia],

    'Flexão diamante para tríceps' => ['cena' => 'He is in a push-up position with both hands together directly under his chest, the two thumbs and the two index fingers touching to form a clear DIAMOND shape on the floor. His body is one straight rigid line from heels to head. '.sprintf($duasPosicoes, 'both arms are completely straight, elbows locked, the body high off the floor', 'both elbows are bent deep and tucked back close against his ribs, his chest almost touching his own hands on the floor').' The elbows fold backward along his sides, never out to the sides. '.$academia],

    'Tríceps banco livre com pés suspensos' => ['execucao' => 'Mãos na borda de um banco atrás e calcanhares apoiados num segundo banco à frente: desça o quadril flexionando os cotovelos e suba.', 'cena' => 'TWO flat benches stand parallel, about the length of his leg apart. His hands grip the near edge of the bench BEHIND him, fingers pointing forward, and his HEELS rest on top of the second bench in FRONT of him, so his legs are straight and suspended in the air. His hips hang in the empty space between the two benches and nothing of him touches the floor at any moment. '.sprintf($duasPosicoes, 'both arms are completely straight, hips lifted high, level with the bench top', 'both elbows are bent to a right angle pointing straight back behind him, hips dropped low toward the floor between the benches').' '.$academia],

    'Tríceps banco livre' => ['execucao' => 'Mãos na borda do banco atrás, pés apoiados no chão: desça o quadril flexionando os cotovelos e suba.', 'cena' => 'He sits at the edge of a flat bench and grips the edge on each side of his hips, fingers pointing forward, then slides his hips off the front. Both FEET stay flat on the FLOOR the whole time with the legs out in front and the knees softly bent: his feet are never on another bench and never in the air. '.sprintf($duasPosicoes, 'both arms are completely straight, hips lifted high, level with the top of the bench', 'both elbows are bent to a right angle pointing straight back behind him, hips dropped low, close to the floor').' '.$academia],

    'Agachamento com peso corporal' => ['cena' => 'He stands on the gym floor with his feet shoulder width apart, hands reaching forward in front of his chest for balance. '.sprintf($duasPosicoes, 'he stands completely tall and upright, knees locked straight, hips high', 'he has sunk DEEP into a squat: his hips are down below the level of his knees, thighs past parallel with the floor, chest up and heels flat on the ground').' It is a big, deep descent that travels most of his leg length, never a small dip of a few centimetres. '.$academia],

    'Agachamento sissy' => ['cena' => 'He is set up in a SISSY SQUAT BENCH: an angled steel frame on the floor with a padded roller clamped across the front of his ankles and a slanted footplate under his feet, holding his lower legs locked in place. He holds the frame handle in front of him with one hand. '.sprintf($duasPosicoes, 'he is upright, knees straight, body vertical over the footplate', 'his knees have travelled far FORWARD and his whole body has leaned BACKWARD in one straight line from knee to head, torso reclined almost parallel with the floor, hips pushed forward').' His hips and shoulders stay in one straight line with his knees the whole time; he never bends at the waist. '.$academia],

    'Elevação pélvica solo unilateral' => ['cena' => 'He lies flat on his back on the gym floor, arms out at his sides for balance. ONE foot is planted flat on the floor with that knee bent; the OTHER leg is lifted and held completely STRAIGHT, pointing up at the ceiling, and it never lowers or bends. '.sprintf($duasPosicoes, 'his hips are resting DOWN on the floor, buttocks touching the ground', 'his hips are driven HIGH so that shoulders, hips and the planted knee form one straight line, glutes squeezed, with the free leg still pointing straight up').' '.$academia],

    'Elevação de quadril unilateral' => ['execucao' => 'Escápulas apoiadas na borda do banco, um pé no chão e a outra perna estendida: suba o quadril até o corpo ficar reto.', 'cena' => 'He is DOWN at floor level with a flat bench standing behind his shoulders, and his body lies across it at a right angle, like a T. Only one narrow strip of him touches the bench: his SHOULDER BLADES, resting on the near edge, with his head hanging free past it. Everything else is off the bench and low: his buttocks are down near the floor and both feet are flat on the ground in front of him. He is never sitting on the bench, never lying along its length, and his hands never hold its edge. ONE foot is planted flat on the floor with the knee bent; the other leg is held straight out in front. '.sprintf($duasPosicoes, 'his hips are dropped LOW toward the floor, well below the bench edge', 'his hips are driven UP until shoulders, hips and the planted knee form one straight horizontal line, glutes squeezed, the free leg still extended').' '.$academia],

    'Elevação pélvica solo' => ['cena' => 'He lies flat on his back on the gym floor, both knees bent with both feet flat on the ground close to his buttocks, arms resting at his sides. '.sprintf($duasPosicoes, 'his hips and buttocks are resting DOWN on the floor, touching the ground', 'his hips are driven HIGH so that shoulders, hips and knees form one straight line, the body lifted well clear of the floor and the glutes squeezed hard').' The hips travel a long way, never a small twitch. '.$academia],

    'Panturrilha em pé no step' => ['execucao' => 'Em pé num step, segurando o espaldar: apenas a ponta dos pés no step, desça e suba os calcanhares.', 'cena' => 'He stands on a low STEP platform with only the BALLS of his feet on it: both heels hang off the back edge over empty air. Both hands hold onto a WALL BAR in front of him at chest height, arms straight, just for balance. His legs stay completely straight and locked and his knees never bend. The only joint that moves is the ankle. '.sprintf($duasPosicoes, 'both heels have dropped far DOWN below the level of the step, calves stretched long, his whole body lowered', 'both heels are pushed far UP so he is high on the balls of his feet, his whole body clearly raised several centimetres higher, calves bunched').' '.$academia],

    'Abdominal bicicleta' => ['cena' => 'He lies on his back on the gym floor with both hands behind his head, elbows wide. He pedals: one knee is pulled in toward his chest while the OTHER leg is pushed out COMPLETELY STRAIGHT, heel hovering just above the floor, and then they swap. '.sprintf($duasPosicoes, 'the right knee is tucked up to his chest and the LEFT leg is stretched out completely straight and long, low above the floor, while his left elbow reaches across toward that right knee', 'the legs have swapped: the left knee is tucked up and the RIGHT leg is stretched out completely straight and long, while his right elbow reaches across toward the left knee').' The extended leg is always fully straight, never left half bent, and the two legs are never in the same position at the same time. '.$academia],
];

// ---------------------------------------------------------------------------
// Revisão do Hugo, 16/09/2026 — família CORE / PESO CORPORAL (lote 5)
//
// Tira de 4 frames (4/28/52/76) dos 14 antes de escrever. Três padrões:
// amplitude zero (remador sentado, joelhos suspenso parado), APARELHO que falta
// (banco declinado de abdômen, apoio das mãos no dragon flag) e POSTURA errada
// no isométrico (L-sit encostado na parede, hollow com pernas altas, bear crawl
// de joelhos). Pegada na barra descrita pelo que a câmera vê.
$pegadaBarra = 'Both hands wrap fully AROUND the bar in an overhand grip, shoulder width apart: the fingers curl over the top and down the far side of the bar, the thumbs close underneath it, so the camera in front sees his FINGERTIPS and fingernails curled over the top of the bar toward the lens and the pale inside of his wrists below it, with only the strap of his wristwatch showing; the thumbs point toward each other. His wrists stay straight under the bar, and his hands never rest flat on top of it or hook it with only the fingertips.';

$revisaoHugoCore = [

    'Abdominal declinado' => ['cena' => 'He lies face up on a dedicated DECLINE SIT-UP BENCH: a long narrow padded board on a steel frame, slanted steeply so the FEET end is high and the HEAD end is low near the floor. At the high end his ankles are hooked under two thick padded foot rollers that hold his legs in place, knees bent. It is never an ordinary flat or adjustable weight bench, and there is NO raised backrest: he never sits upright on a seat. His HEAD is always LOWER than his hips and his feet are the highest point of his body, so in the START POSITION he lies head-down along the slope. His hands are crossed on his chest. '.sprintf($duasPosicoes, 'his back lies flat along the slanted board, head down at the low end, shoulders touching the pad', 'his torso has curled all the way UP until his chest is close to his thighs, back clear of the board').' '.$academia],

    'Abdominal remador' => ['execucao' => 'Deitado no chão, braços acima da cabeça e pernas estendidas: sente-se trazendo os joelhos ao peito e volte a deitar.', 'cena' => 'He is on the gym floor on his back. '.sprintf($duasPosicoes, 'he lies COMPLETELY FLAT on his back on the floor, both arms stretched straight back past his head along the floor and both legs straight out, the whole body long and touching the ground from hands to heels', 'he has sat UP: torso upright, both knees pulled in tight against his chest, feet just off the floor, arms reaching forward alongside his shins').' Each repetition goes all the way down to lying flat, never stopping half way in a seated position. '.$academia],

    'Dead bug' => ['cena' => 'He lies flat on his back on the gym floor, lower back pressed into the ground, filmed from the SIDE, the camera low and level with him so his whole body is seen in profile against the gym behind. He holds the 90/90 position the whole time: both thighs stand straight UP, vertical, with both knees bent at a right angle so the two shins float parallel with the floor, like the four legs of an upturned table. Both feet hover in the air and NEVER touch the floor, and the non-moving leg keeps that folded shape in every single frame. Both arms point straight UP at the ceiling. '.sprintf($duasPosicoes, 'both arms point straight up and both knees are bent at a right angle above his hips', 'his LEFT arm is stretched back overhead, hovering just above the floor behind his head, while at the same time his RIGHT leg is stretched out completely straight, hovering just above the floor; the right arm and the left leg stay exactly where they were').' Only ONE arm and ONE leg move at a time, always opposite sides, and his back never lifts off the floor. His two arms NEVER move together, and his FEET NEVER rest on the floor: the bent legs stay lifted in the air. The moving leg UNFOLDS completely, like a jackknife opening: its knee LOCKS straight and the heel travels far away from his buttocks until that whole leg is long, low and horizontal, hovering a hand width above the floor with the heel almost touching it, and only then does it fold back up. It is never left bent at a right angle, and the extended leg never points up toward the ceiling. It is never a sit-up or a crunch: his head and shoulders never curl up. '.$academia],

    'Dragon flag' => ['cena' => 'He lies face up along a flat bench. Both hands reach back past his head and GRIP the edge of the bench beside his ears, arms bent, fists clearly closed around the bench — his hands are never behind his neck or on his head. Only his upper back and shoulders rest on the bench. '.sprintf($duasPosicoes, 'his whole body is raised in one STRAIGHT rigid line from shoulders to toes, pointing up at a steep angle, hips fully extended', 'the same straight rigid body has lowered slowly until it hovers just above the bench, still one straight line, hips never folding')." He moves like a stiff plank pivoting at the shoulders: his hips never bend, and his legs are never lifted alone while his hips stay on the bench. ".$academia],

    'Abdominal infra suspenso flexionando as pernas' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' '.sprintf($duasPosicoes, 'both legs hang straight down below him, relaxed', 'both KNEES are pulled up HIGH, above the level of his hips and close to his chest, thighs past horizontal and knees bent')." His torso stays still under the bar without swinging. ".$academia],

    'Abdominal infra suspenso com pernas estendidas' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' '.sprintf($duasPosicoes, 'both legs hang straight down below him', 'both legs are raised together, knees LOCKED STRAIGHT, up to HORIZONTAL, forming an L shape with his torso, toes pointing forward at the camera')." The knees never bend and the feet never go up to touch the bar. ".$academia],

    'Hollow hold' => ['estatico' => true, 'execucao' => 'Deitado de barriga para cima, lombar colada no chão, braços estendidos atrás da cabeça e pernas estendidas alguns centímetros acima do solo.', 'cena' => 'He lies on his back on the gym floor, filmed from the SIDE, in a hollow body hold. His lower back stays pressed flat into the floor. Both arms are stretched completely STRAIGHT, reaching BACK beyond the top of his head, biceps beside his ears, hands far away from his head and hovering LOW just above the floor behind him. His hands are NEVER clasped behind his head or neck and his elbows are never bent. Both legs are straight and together, lifted only a LITTLE: his heels hover LOW, just a hand width above the floor, never pointing up at the ceiling. His head and shoulder blades are lifted slightly off the floor. The whole body forms a long, shallow banana curve. It is an isometric hold: he stays in this position, breathing, with the body trembling slightly from the effort, never sitting up. '.$academia],

    'Hollow rock' => ['cena' => 'He lies on his back on the gym floor, filmed from the SIDE, in a hollow body position: both arms stretched completely STRAIGHT, reaching back beyond the top of his head beside his ears, hands far away from his head and NEVER clasped behind his head or neck, legs straight and together, both arms and legs held LOW, only a little above the floor, the body a long shallow banana curve. He is never in a V-sit with arms and legs pointing up at the ceiling. '.sprintf($duasPosicoes, 'he has rocked BACK: his upper back touches the floor and his feet have risen a little higher', 'he has rocked FORWARD: his lower back and buttocks touch the floor and his hands have risen a little while his heels come close to the floor')." His whole rigid body rocks back and forth like a rocking chair, and the rocking is clearly visible; he never does a crunch or a sit-up. His legs NEVER lie flat on the floor: both heels stay lifted off the ground the whole time, and his arms never reach forward toward his knees. ".$academia],

    'L-sit no solo' => ['estatico' => true, 'cena' => 'He is in the middle of the open gym floor, far from any wall — nothing touches his back. He sits with both legs straight together out in front of him, both palms flat on the floor right beside his hips, arms locked STRAIGHT. He pushes down through his hands and his BUTTOCKS lift a few centimetres OFF the floor, with both straight legs also held just off the ground, so that ONLY his two hands touch the floor. His torso is upright and his body stays LOW, close to the ground, never raised high like a seat in the air. It is an isometric hold: he holds still, arms shaking slightly with effort. '.$academia],

    'Abdominal pára-brisa suspenso na barra' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' Both legs are straight and together and are raised HIGH, pointing UP toward the bar, so his body is folded in a tight pike with the feet up near the level of his hands. The legs NEVER hang down low. '.sprintf($duasPosicoes, 'the raised straight legs are swung far over to his LEFT side, feet high', 'the raised straight legs are swung far over to his RIGHT side, feet still high')." The feet sweep a wide arc over the top, like a windscreen wiper, and stay high the whole time: halfway through each sweep the feet pass straight UP near the bar between his hands. At NO moment do his legs drop down to hang below him, and he never returns to a straight dead hang between sweeps. ".$academia],

    'Mountain climber lento' => ['cena' => 'He is in a high plank on the gym floor, filmed from the SIDE, hands flat under his shoulders, arms straight, body in one straight line. '.sprintf($duasPosicoes, 'his RIGHT knee is drawn forward under his body toward his RIGHT elbow, while the LEFT leg stays straight back with the left toes on the floor', 'the legs have switched: the right leg is back straight with the toes on the floor and the LEFT knee is drawn forward toward his LEFT elbow')." Each knee travels straight forward on its own side: the legs never cross under his body and a foot never lands on the opposite side. He moves slowly. ".$academia],

    'Prancha dinâmica (up-down)' => ['cena' => 'He is on the gym floor, filmed from the SIDE so his whole body is seen in profile, body in one straight rigid line from heels to head, feet apart, hips never sagging or piking up. '.sprintf($duasPosicoes, 'HIGH plank: both arms completely straight, palms flat on the floor under his shoulders', 'LOW plank: both FOREARMS flat on the floor, elbows under his shoulders, the body clearly lower')." He goes down one arm at a time (one forearm, then the other) and comes back up one arm at a time (one hand, then the other). ".$academia],

    'Toes to bar' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' '.sprintf($duasPosicoes, 'both legs hang straight down below him', 'both straight legs have swung all the way UP so the tips of his shoes TOUCH the bar between his hands, his body folded in a tight pike')." His hands stay wrapped on the bar in exactly the same place the whole time. ".$academia],

    'Bear crawl' => ['cena' => 'He is on all fours on the gym floor, filmed from the SIDE: hands flat under his shoulders, feet on the balls of the toes, and his KNEES LIFTED and hovering just a few centimetres ABOVE the floor. His knees NEVER touch the ground, and his back stays flat like a table. He crawls FORWARD across the floor, moving the opposite hand and foot together (right hand with left foot, then left hand with right foot), with small steps, and his knees stay low and hovering the whole time. '.$academia],
];

// ---------------------------------------------------------------------------
// Revisão do Hugo, 17/09/2026 — família POLIA (lote 6, 15 de 16)
//
// Tira de 4 frames dos 15 antes de escrever. Os erros se repartem em três:
// (a) ORIGEM DO CABO — #140 pede polia do chão e o vídeo puxa do topo;
// (b) IDENTIDADE DO ANEXO — #75, #76 e #80 saem todos com a mesma barra reta
//     larga, quando o Hugo pede triângulo, pegada neutra e pegada supinada;
// (c) AMPLITUDE — o resto quase não se move, principalmente as quatro de
//     tornozeleira, que mexem a perna alguns centímetros.
//
// Fora do lote: #83 "Remada baixa com corda" vira "remada com argola", e o
// nome atual (com "corda") entraria no prompt brigando com a cena. Gerar esse
// depois do rename.
$poliaTornozelo = 'One padded ANKLE CUFF is buckled around one ankle, low down on the leg, and a single steel cable runs from that cuff DOWNWARD to a pulley wheel at FLOOR level at the base of the tower. Everything above the height of his hips is empty air: no cable, no pulley and no handle appears anywhere near his hands or above his head, and the top of the tower is bare. The cuff is never on his wrist: his hands hold only the bare steel frame of the tower, never a cable handle, and no cable ever reaches them. Only the cuffed leg moves; the other foot stays planted flat on the floor and its knee stays still.';

$poliaNaAltura = 'A single steel cable runs HORIZONTALLY, flat and level with the floor, from his hand sideways to a pulley wheel bolted halfway up the tower at exactly the height of his own ELBOW. The cable never slopes downward and never comes from above: everything ABOVE the height of his shoulder is empty air, with no cable, no pulley and no attachment anywhere up there, and the top of the tower is completely bare.';

$bancoPulldown = 'He sits on the seat of a LAT PULLDOWN station, facing the tower: a thick padded thigh bar is clamped down across the top of both thighs, holding him in the seat, and the pulley and the rectangular weight stack are directly in front of him and above his head. He is never standing, never on a flat bench and never on a chair without the thigh pad.';

// Amplitude que não veio em 3 rolagens: duas repetições em 4s deixam pouco
// espaço pro percurso. Uma repetição lenta ocupando o clipe inteiro dá tempo
// de percorrer a distância toda.
$umaRepLenta = 'The clip shows ONE single slow repetition that fills the whole clip: he travels without pause from one position to the other and back, unhurried, and the two positions are unmistakably different. START POSITION: %s. END POSITION: %s.';

$revisaoHugoPolia = [

    'Crossover' => ['cena' => 'He stands in the middle of a CABLE CROSSOVER frame, one tall tower on his left and one on his right, filmed from the front. He holds one single D-handle in each hand, and from each handle a steel cable rises diagonally UP and outward to a pulley wheel fixed at the very TOP of the tower on that side, well above his head. There are exactly two cables, one per hand, each attached in every frame; no cable comes from the floor and no pulley sits below his hands. His torso leans slightly forward and one foot is a step ahead of the other. His elbows stay almost straight, only slightly bent, and they never fold shut. '.sprintf($duasPosicoes, 'both arms are spread WIDE open out to the sides at shoulder height, chest stretched, the hands far apart and level with his shoulders', 'both arms have swept DOWN and INWARD in a big arc until the two hands meet and cross in front of his hips, below his navel, elbows still almost straight').' It is a wide sweeping arc of the whole arm, never a pressing movement with bending elbows, and it is never a pec deck machine. '.$academia],

    'Pullover na polia alta' => ['cena' => $deFrente.' He holds a short straight cable bar in both hands with an overhand grip, palms down. '.$poliaAlta.' Both ELBOWS stay LOCKED STRAIGHT from the first frame to the last: the arms are two rigid straight lines pivoting only at the shoulders, and the elbows never bend at any moment. '.sprintf($duasPosicoes, 'both straight arms are raised high in front of him, the bar up at the height of his forehead, and his torso is upright with a slight forward lean', 'both straight arms have swept all the way DOWN in a long arc until the bar touches the front of his THIGHS, close to his body').' It is never a triceps pushdown: the elbows do not fold, and the movement is the whole straight arm travelling in an arc. '.$cabo.' '.$academia],

    'Face pull' => ['cena' => $deFrente.' '.$corda.' The rope hangs from a single pulley wheel fixed HIGH on the tower, clearly ABOVE the top of his head, and one single steel cable runs from the rope straight UP to it. Everything BELOW the height of his hands is empty air: no cable runs down toward the floor, no pulley sits at floor level, and there is never a second cable and never one cable per hand. '.sprintf($duasPosicoes, 'both arms are stretched straight out in FRONT of him at eye level, the rope pulled long and the hands together far away from his face', 'both hands have been pulled back to each side of his FACE, level with his ears, the two rope ends passing on either side of his head, with both ELBOWS lifted HIGH and flared far out to the sides, level with his shoulders or above them').' The hands finish beside his face, never down at his chest and never at his belly, and the elbows are always higher than his wrists. '.$academia],

    'Puxada frontal pegada neutra' => ['cena' => $bancoPulldown.' The attachment is a small V-SHAPED DOUBLE HANDLE: two short steel grips welded side by side into one small piece no wider than his own head, each grip pointing toward him like the handle of a suitcase. Look at its ENDS: the metal stops right at the outside of each fist and there is nothing beyond it — no long shaft, no bar reaching out toward his shoulders, no rubber ends far from his hands. He grips it with both PALMS FACING EACH OTHER, thumbs up, the two fists close together and never wider apart than his own head. It is never a long straight lat bar, never an angled bar, and nothing crosses the frame above his head from one side to the other. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, shoulders pulled up beside his ears, the handle high near the pulley', 'the handle has been pulled all the way DOWN to touch the top of his CHEST, both elbows folded and driven down close beside his ribs, chest lifted and shoulder blades squeezed together').' '.$cabo.' '.$academia],

    'Puxada frontal pegada supinada' => ['cena' => $bancoPulldown.' He holds a SHORT straight cable bar, no wider than his own shoulders, with an UNDERHAND grip. The camera in front of him sees the grip clearly and unmistakably: the OPEN PALMS are turned up toward the ceiling and toward his own face, the pale inner side of both forearms and the bulging biceps face the lens, and the fingers curl up and around the bar from underneath. The backs of his hands and his KNUCKLES are HIDDEN from the camera in every single frame, hidden away on the far side of the bar, and the knuckles are never on top of the bar. It is never an overhand grip and never a wide angled lat bar. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, the bar high near the pulley', 'the bar has been pulled all the way DOWN to the top of his CHEST, both elbows folded and pointing down close beside his ribs').' '.$cabo.' '.$academia],

    'Puxada triângulo' => ['cena' => $bancoPulldown.' The attachment is one small closed TRIANGLE of steel, about the size of a dinner plate, hanging point-up from the cable: two bars rising to a point at the top where the cable clips on, and one short horizontal grip bar closing the bottom, which he holds with BOTH hands together, the two fists touching in the middle and the PALMS FACING EACH OTHER. The whole piece fits inside the width of his own head. Nothing sticks out past his fists: no shaft, no rubber end, no metal reaching toward his shoulders, and nothing crosses the frame above his head from one side to the other. It is never a long straight lat bar, never a wide bar, never a W or EZ bar. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, the triangle high near the pulley', 'the triangle has been pulled all the way DOWN to touch the top of his CHEST, both elbows folded and driven down close beside his ribs, chest lifted').' '.$cabo.' '.$academia],

    'Remada baixa' => ['cena' => 'He sits on the long padded seat of a SEATED CABLE ROW station, facing the tower, both feet braced flat against the steel footplate in front of him and the knees slightly bent. A single steel cable runs from the handle in his hands forward and DOWN to a pulley wheel at FLOOR level between his feet, at the base of the tower; nothing hangs above his head and the top of the tower is bare. He holds a small short handle in both hands, palms facing each other. His back stays straight and his torso stays upright and almost still, rocking no more than a few centimetres. '.sprintf($duasPosicoes, 'both arms are stretched completely STRAIGHT out in front of him, the handle far away near the pulley, shoulders reaching forward', 'the handle has been pulled all the way back to touch his BELLY just above the navel, both elbows driven far BACK so they pass behind the line of his ribs, shoulder blades squeezed together').' It is a long, obvious travel of the handle, never a short tug with the arms half straight. '.$academia],

    'Remada alta na polia baixa' => ['cena' => $deFrente.' He holds a short straight cable bar in both hands with an overhand grip, palms turned down, the two fists close together near the middle of the bar. '.$poliaBaixa.' '.sprintf($duasPosicoes, 'both arms hang completely straight DOWN in front of his thighs, the bar touching the front of his legs, shoulders relaxed', 'the bar has been pulled straight UP along his body until it is at the height of his COLLARBONE, just under his chin, with both ELBOWS lifted HIGH and pointing out to the sides, clearly ABOVE the level of his hands and above his shoulders').' The elbows lead the movement and are higher than the wrists in every frame of the way up: at the top the two elbows are the highest part of his arms, pointing out sideways above the bar like two wings. One single steel cable is VISIBLE in every single frame, running from the middle of the bar straight DOWN to the pulley wheel at floor level between his feet: the bar is never free-floating, never a loaded barbell and never disconnected from the cable. '.$cabo.' '.$academia],

    'Rotação externa na polia' => ['execucao' => 'Em pé de lado para a polia, cotovelo colado ao corpo e flexionado a 90°: gire o antebraço para FORA, afastando a mão do abdômen, e volte controlado.', 'cena' => 'He stands SIDE-ON to a cable tower, filmed from the front, the tower at his LEFT side. The working arm is his RIGHT arm, the one FARTHER from the tower, and the cable crosses in front of his body to reach it. '.$poliaNaAltura.' His right UPPER ARM is pinned tight against his ribs and stays completely still, as if a folded towel were held in his armpit, and his right elbow is bent to a right angle the whole time. The forearm is the only part that travels, swinging in a horizontal arc like a gate. '.sprintf($duasPosicoes, 'the right forearm is across the front of his belly, the hand near his navel, pointing toward the tower on his left', 'the right forearm has rotated OUTWARD, away from his body, until it points straight forward away from his right hip; the elbow is still pinned against the ribs and the hand is still at the same height as the elbow').' The elbow never lifts away from his side, the hand never rises above elbow height, and it is never a biceps curl and never a press. His other hand hangs relaxed, holding nothing. '.$academia],

    'Rotação interna na polia' => ['cena' => 'He stands SIDE-ON to a cable tower, filmed from the front, the tower at his RIGHT side. The working arm is his RIGHT arm, the one NEAREST the tower. '.$poliaNaAltura.' His right UPPER ARM is pinned tight against his ribs and stays completely still, and his right elbow is bent to a right angle the whole time. The forearm is the only part that travels, swinging in a horizontal arc like a gate. '.sprintf($duasPosicoes, 'the right forearm points straight OUT to his right side, away from his body, toward the tower, the hand level with the elbow', 'the right forearm has rotated INWARD across his body until the hand rests against the front of his BELLY at the navel, the elbow still pinned against his ribs').' The elbow never lifts away from his side, the hand never rises above elbow height, and it is never a curl and never a press. His other hand hangs relaxed, holding nothing. '.$academia],

    'Glúteo coice na polia' => ['cena' => 'He stands facing a cable tower and holds the steel frame of the tower with both hands at chest height, his torso leaning clearly FORWARD, about halfway to horizontal. '.$poliaTornozelo.' The cuffed leg stays almost straight, the knee only slightly bent, and it sweeps in a long arc backward. '.sprintf($duasPosicoes, 'the cuffed leg is drawn FORWARD so the knee comes up in front of his body toward his chest and the hip is deeply folded, the foot off the floor well ahead of the standing foot', 'the same leg has swept far BACK behind him, the whole leg lifted high above the line of his hips, hip fully open and the glute squeezed, the body from head to that heel in one long line').' It is a big, obvious sweep through most of a quarter circle, never a small backward nudge of a few centimetres. '.$academia],

    'Abdução de quadril na polia' => ['cena' => 'He stands with a cable tower close to his LEFT side and holds its frame with his left hand for balance. The CAMERA IS DIRECTLY IN FRONT OF HIM and stays there: his chest, both shoulders and his face are turned toward the lens in every single frame, and he is NEVER seen in profile, never side-on to the camera and never from behind. The tower stands beside him, at the edge of the frame.  The working leg is his RIGHT leg, the one FARTHER from the tower, and the cable crosses low in front of his left shin to reach the cuff on his right ankle. '.$poliaTornozelo.' His torso stays upright and vertical over the standing foot the whole time, and the working knee stays locked STRAIGHT. '.sprintf($umaRepLenta, 'both feet are together on the floor, ankles almost touching, the legs closed', 'the whole right leg has been lifted far OUT to his right side, straight as a pole and rigid, until the foot is as HIGH as his own HIP and the two legs form a wide upside-down V, with the gap between the two feet wider than his own shoulders — an extreme, almost gymnastic opening, the raised foot clearly higher than the other knee').' On the screen, the working foot travels ACROSS the picture, sliding sideways from the middle of the frame toward its RIGHT edge and back, always at the same distance from the camera. It NEVER travels toward the camera, never away from it, never forward in front of his body and never backward behind him: the knee never comes up in front of his belly and the foot never ends up behind the standing heel. This is never a forward knee raise, never a backward kick and never a glute kickback. The gap between his two feet opens wide and obvious, like a compass opening. His shoulders never tip over to the other side. '.$academia],

    'Adução de quadril na polia' => ['cena' => 'He stands with a cable tower close to his RIGHT side and holds its frame with his right hand for balance. The CAMERA IS DIRECTLY IN FRONT OF HIM and stays there: his chest, both shoulders and his face are turned toward the lens in every single frame, and he is NEVER seen in profile, never side-on to the camera and never from behind. The tower stands beside him, at the edge of the frame.  The working leg is his RIGHT leg, the one NEAREST the tower, so the cable pulls that leg out to the right. '.$poliaTornozelo.' His torso stays upright and vertical the whole time and the working knee stays locked STRAIGHT. '.sprintf($umaRepLenta, 'the right leg is stretched far OUT to his right side, straight and rigid, the foot as high as his own knee, the two legs wide apart in a big V', 'that same straight leg has swept all the way DOWN and ACROSS, passing IN FRONT of the standing left leg, until the right foot is clearly on the LEFT side of the standing foot, the two legs crossed like a pair of closed scissors and the thighs pressed together').' On the screen, the working foot travels ACROSS the picture, sliding sideways from the RIGHT edge of the frame toward the middle and past it, always at the same distance from the camera. It NEVER travels toward the camera, never away from it, never forward in front of his body and never backward behind him: the knee never comes up in front of his belly and the foot never ends up behind the standing heel. This is never a forward knee raise, never a backward kick and never a glute kickback. The two legs finish visibly crossed, like a pair of scissors. '.$academia],

    'Glúteo no cabo (coice)' => ['cena' => 'He stands facing a cable tower and holds its steel frame with both hands at chest height, his torso leaning clearly FORWARD, about halfway to horizontal, and it stays at that angle without straightening up. '.$poliaTornozelo.' The cuffed knee is bent to a right angle and stays bent the whole time, so the sole of that foot faces the ceiling, and the movement is the whole thigh pivoting at the hip. '.sprintf($duasPosicoes, 'the cuffed knee is drawn FORWARD and UP under his chest, the hip deeply folded, the thigh close to his own belly', 'the same bent leg has been driven far BACK and UP behind him, the thigh lifted above the line of his back and the sole of the foot pressed up toward the ceiling, hip fully open and the glute squeezed hard').' It is a big travel of the thigh through most of a quarter circle, never a small backward nudge. '.$academia],

    'Pallof press' => ['execucao' => 'De lado para a polia, na altura do peito, com as duas mãos num só puxador: estenda os braços à frente e SUSTENTE, sem deixar o tronco girar.', 'cena' => 'He stands SIDE-ON to a cable tower, filmed from the front, the tower at his LEFT side, feet apart and firmly planted. BOTH hands grip ONE single D-handle together, one hand over the other, held at the centre of his chest. '.$poliaNaAltura.' The cable stays out at his LEFT side in every single frame, pulling him sideways, and it never comes from in front of him or from above. He presses both arms straight out in FRONT of his sternum, until the two elbows are locked and the handle is far from his chest, and then HOLDS that position, arms straight and trembling with the effort of resisting, before slowly bringing the hands back to his chest. His shoulders and hips stay square and facing the camera the whole time: the torso never twists toward the tower, the arms never drift sideways toward it, and he never turns to face it. There is a long, visible hold with the arms extended; it is never a fast repeated pressing motion. '.$academia],
];

// ---------------------------------------------------------------------------
// Revisão do Hugo, 17/09/2026 — família PESO LIVRE (lote 7)
//
// Tira de 4 frames dos 12 antes de escrever. Quatro padrões: BANCO errado
// (#35 e #39 saem quase planos), ANILHA onde o Hugo não quer (#57), PEGADA
// (#92 e #160) e IDENTIDADE DA BARRA — W x reta em quatro itens (#155, #166,
// #167, #199), que é a mesma família de erro das puxadas do lote 6. Mais
// amplitude nos tríceps testa e no encolhimento.
$barraW = 'The bar is an EZ CURL BAR: its middle section is BENT into a zigzag of two shallow waves, like a flattened letter W, and his hands sit in those two angled bends with the wrists tilted inward. The bend is obvious in every frame: the bar is never one straight line from end to end.';

$barraReta = 'The bar is perfectly STRAIGHT: one single straight steel line from one end to the other, with no bend, no wave and no zigzag anywhere along it. It is never an EZ or W curl bar.';

$bancoScott = 'He sits at a PREACHER BENCH: a thick padded board slanted in front of him like a lectern, and the BACK of both upper arms lies flat along that pad from armpit to elbow, pressed into it and never lifting off. His chest rests against the top edge of the pad.';

$cotovelosParados = 'Both UPPER ARMS stay completely still and vertical, pointing straight up at the ceiling, close beside his head: only the forearms fold and unfold, hinging at the elbow. The elbows never travel forward over his face, never sink toward his chest and never flare out sideways.';

$revisaoHugoPesoLivre = [

    'Supino declinado' => ['cena' => 'He lies on a DECLINE bench: the bench is clearly tilted so the HEAD end is LOW, near the floor, and the FEET end is HIGH, with his ankles hooked under the padded rollers at the top. His head is always lower than his hips, and the bench is never flat and never tilted the other way. He holds a straight barbell with both hands, palms forward, hands wider than his shoulders. '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT UP above his lower chest, elbows locked, the bar high and far from his body', 'both elbows are bent deep and pulled down beside his ribs until the bar TOUCHES the lower part of his chest, the bar clearly resting against him').' The bar travels the whole length of his arms every time, never hovering half way. '.$academia],

    'Supino inclinado' => ['cena' => 'He lies on an INCLINE bench: the backrest is raised so the HEAD end is clearly HIGHER than the hips, the torso tilted up at about forty-five degrees like a reclined chair, and his hips sit lower than his shoulders. It is never a flat horizontal bench and never a decline. He holds a straight barbell with both hands, palms forward, hands wider than his shoulders. '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT UP above his UPPER chest, elbows locked', 'both elbows are bent deep until the bar TOUCHES the top of his chest, just under his collarbones, elbows below the line of his shoulders').' '.$academia],

    'Bom dia com barra' => ['cena' => 'He stands with a straight steel barbell resting across his upper back and shoulders, behind his neck, held with both hands. The bar is COMPLETELY BARE: there are NO weight plates on it, no discs, no collars and no clips — both ends are plain empty metal, and nothing black or round hangs at either end. '.sprintf($duasPosicoes, 'he stands tall and upright, knees almost straight, the bar level across his shoulders', 'he has HINGED at the hips: the hips travel far BACK behind his heels and the torso tips forward until it is almost parallel with the floor, back flat as a table and knees only slightly bent').' It is a HIP HINGE, never a squat. Watch the two ends of his body: the HEAD travels far FORWARD and DOWN, ending out over his toes at the height of his own hips, while the BUTTOCKS travel far BACKWARD, ending behind his heels, as if he were closing a door with them. The knees stay almost straight and their angle barely changes from the first frame to the last; the hips never drop DOWN between his feet and he never sinks into a squat. '.$academia],

    'Remada curvada pegada supinada' => ['cena' => 'He stands holding a straight barbell with an UNDERHAND grip, and the camera sees the grip clearly: both PALMS are turned UP and FORWARD, away from his legs, the pale inner side of both forearms facing the lens, and the knuckles and the backs of his hands are hidden underneath the bar in every frame. It is never an overhand grip. His torso is bent far FORWARD at the hips and stays there the whole clip: the chest faces the FLOOR, the shoulders are clearly LOWER than the hips, the back is flat like a table top and the head points forward, out over his toes. He is NEVER standing upright, the chest never faces the camera, and the torso never rises during the movement — only the arms travel. '.sprintf($duasPosicoes, 'both arms hang completely straight down toward the floor, the bar at knee height', 'the bar has been pulled UP to touch his lower belly, both elbows driven back past the line of his ribs, shoulder blades squeezed together').' '.$academia],

    'Rosca direta com barra W' => ['cena' => 'He stands upright holding a curl bar in both hands with an underhand grip, palms up. '.$barraW.' '.sprintf($duasPosicoes, 'both arms hang completely straight down in front of his thighs, the bar resting against his legs', 'both elbows are folded shut and the bar is up at the height of his collarbones, close to his chest').' Both upper arms stay pinned against his ribs and completely still; only the forearms travel. '.$academia],

    'Rosca inversa' => ['cena' => 'He stands upright holding a straight barbell with an OVERHAND grip: both palms are turned DOWN toward the floor and the KNUCKLES and the backs of both hands face the camera in every single frame, on TOP of the bar. His palms never turn up and it is never an underhand curl. '.$barraReta.' '.sprintf($duasPosicoes, 'both arms hang completely straight down in front of his thighs, the bar against his legs, knuckles up', 'both elbows are folded shut and the bar is up at the height of his collarbones, the knuckles leading and still facing the camera').' Both upper arms stay pinned against his ribs and still. '.$academia],

    // O Hugo quer 'rosca scott com barra reta': a cena usa barra reta, então o
    // equipamento da biblioteca (Barra W) contradiria o prompt.
    'Rosca Scott com barra reta' => ['equipamento' => 'Barra', 'cena' => $bancoScott.' He holds a bar in both hands with an underhand grip, palms up. '.$barraReta.' '.sprintf($duasPosicoes, 'both arms are stretched almost completely STRAIGHT down along the slanted pad, the bar low and far from his face, elbows open', 'both elbows are folded shut and the bar has been curled UP to the height of his chin, close to his face').' The back of both upper arms never leaves the pad. '.$academia],

    'Rosca Scott com barra W' => ['cena' => $bancoScott.' He holds a curl bar in both hands with an underhand grip, palms up. '.$barraW.' '.sprintf($duasPosicoes, 'both arms are stretched almost completely STRAIGHT down along the slanted pad, the bar low and far from his face, elbows open', 'both elbows are folded shut and the bar has been curled UP to the height of his chin, close to his face').' The back of both upper arms never leaves the pad. '.$academia],

    // Barra reta aqui é o que separa este do #199 'com barra W'.
    'Tríceps testa' => ['equipamento' => 'Barra', 'cena' => 'He lies flat on his back on a flat bench, feet on the floor, holding a straight barbell above him with both hands, palms facing his feet, hands about shoulder width apart. '.$barraReta.' '.$cotovelosParados.' '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT UP, elbows locked, the bar directly above his shoulders', 'both elbows are folded shut so the bar comes DOWN to touch his FOREHEAD, just above his eyebrows, the forearms folded back beside his ears').' It is never a bench press: the bar never travels down to his chest and the upper arms never tip toward his feet. '.$academia],

    'Tríceps testa com barra W' => ['cena' => 'He lies flat on his back on a flat bench, feet on the floor, holding a curl bar above him with both hands, palms facing his feet. '.$barraW.' '.$cotovelosParados.' '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT UP, elbows locked, the bar directly above his shoulders', 'both elbows are folded shut so the bar comes DOWN to touch his FOREHEAD, just above his eyebrows').' It is never a bench press: the bar never travels down to his chest. '.$academia],

    'Tríceps testa com halteres' => ['cena' => 'He lies flat on his back on a flat bench, feet on the floor, holding ONE dumbbell in EACH hand above him, the two palms facing each other. '.$cotovelosParados.' '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT UP, elbows locked, the two dumbbells above his shoulders', 'both elbows are folded shut so the two dumbbells come DOWN one on each side of his HEAD, level with his ears, the forearms folded back past his temples').' It is a deep, obvious fold of the elbow, never a small dip, and the two dumbbells never travel toward his chest. '.$academia],

    'Encolhimento com halteres' => ['cena' => 'He stands upright holding ONE dumbbell in each hand, arms hanging straight down at his sides, palms facing his thighs. Both ELBOWS stay completely STRAIGHT and locked the whole time and the arms never bend: the dumbbells hang like two weights on ropes and only the shoulders move. '.sprintf($duasPosicoes, 'both shoulders are dropped DOWN and relaxed, as low as they go, the neck looking long', 'both shoulders are shrugged UP as high as they will go, squeezed toward his EARS, the trapezius bunched up on each side of his neck and the neck looking short').' The lift is obvious and travels several centimetres, never a small twitch, and the dumbbells rise and fall with the shoulders. '.$academia],
];

// ---------------------------------------------------------------------------
// Revisão do Hugo, 18/09/2026 — lote 8 (mistos: TRX, elástico, smith, caneleira)
//
// Tira de 4 frames dos 13 antes de escrever. Erros por tipo: POSIÇÃO do corpo
// (#23 TRX quase em pé, #238 barra atrás do pescoço, #311 nas mãos e sem
// colchonete, #319 sem banco), MOVIMENTO trocado (#216 encolhimento virou
// remada alta), APARELHO trocado (#398 saiu air bike com ventilador) e
// amplitude/detalhe no resto.
$miniband = 'A small thick RED elastic loop band, a closed ring about the width of his two hands, is stretched around BOTH legs just above the knees, pulling them toward each other. It stays visible and taut around his legs in every single frame and never turns into a rope, a strap or two separate bands.';

$revisaoHugoMistos = [

    'Flexão de braço no TRX' => ['cena' => 'He faces AWAY from the anchor point, filmed from the SIDE, gripping the two handles of a TRX suspension strap that hang from a high anchor behind him. His feet are planted far back on the floor so his body is one straight rigid plank from heels to head, leaning FORWARD at about forty-five degrees, with the straps running up and back over his shoulders. He is never standing upright and never facing the anchor. '.sprintf($duasPosicoes, 'both arms are pushed completely STRAIGHT out in front of his chest, the body high', 'both elbows are bent deep and his CHEST has dropped forward BETWEEN the two handles, the hands beside his ribs, the body much lower and closer to the floor').' The body stays a straight plank the whole time; the hips never sag and never pike. '.$academia],

    'Rotação externa com elástico' => ['cena' => 'He stands SIDE-ON to a tall steel post, filmed from the front, the post at his LEFT side. A thick RED elastic band is tied to that post at the height of his ELBOW and runs horizontally across the front of his body to his RIGHT hand, which grips its end. His right UPPER ARM is pinned tight against his ribs and stays completely still, and his right elbow is bent to a right angle the whole time. The forearm is the only part that travels, swinging in a horizontal arc like a gate. '.sprintf($duasPosicoes, 'the right forearm lies across the front of his belly, the hand near his navel, pointing toward the post', 'the right forearm has rotated OUTWARD, away from his body, until it points straight forward away from his right hip, the band stretched long, the elbow still pinned against the ribs')." The elbow never lifts away from his side, the hand never rises above elbow height, and it is never a curl and never a press. His right ARM is NEVER stretched out straight: the elbow stays folded at a right angle and glued to his ribs in every single frame. His left hand hangs relaxed, holding nothing. ".$academia],

    'Encolhimento no smith' => ['cena' => 'He stands inside a SMITH MACHINE, facing the camera, holding the guided bar with both hands at arm length in front of his THIGHS, palms facing his legs. Both ELBOWS stay completely STRAIGHT and locked the whole time: the arms are two straight ropes, and the bar NEVER rises above the middle of his thighs. It is never an upright row and never a curl: the bar never comes up toward his chest. Only the shoulders move. '.sprintf($duasPosicoes, 'both shoulders are dropped DOWN and relaxed, as low as they go, the neck looking long', 'both shoulders are shrugged UP as high as they will go, squeezed toward his EARS, the trapezius bunched up on each side of his neck, the bar lifted only a few centimetres along his thighs')." ".$academia],

    'Agachamento frontal' => ['cena' => 'He stands holding a straight barbell with weight plates, and the bar rests across the FRONT of his shoulders, in front of his neck, lying on his collarbones just under his chin. His ELBOWS point straight FORWARD and HIGH, level with the bar, his fingertips hooked under the bar beside his shoulders. The bar is NEVER behind his neck and never on his upper back: the camera sees it crossing in front of his throat in every single frame. His torso stays upright. '.sprintf($duasPosicoes, 'he stands tall, knees straight, the bar across the front of his shoulders', 'he has sunk DEEP into a squat, hips below the level of his knees, torso still upright, elbows still high and the bar still on the front of his shoulders')." ".$academia],

    'Extensão de joelho com caneleira' => ['cena' => 'He sits upright at the END of a HIGH padded bench that is taller than his own knees, the whole back of both thighs supported on the pad, so both lower legs hang down freely and BOTH FEET dangle clearly in the air, a hand width above the floor, in every single frame. Only his RIGHT leg moves; the left lower leg hangs still. His hands hold the sides of the bench. One padded ANKLE WEIGHT is strapped around his right ankle. It is never a low stool and his feet never rest on the ground. '.sprintf($duasPosicoes, 'the right lower leg hangs straight DOWN, knee bent to a right angle, the foot below the bench', 'the right knee is fully STRAIGHT, the whole right leg lifted out in front of him and level with the bench, the ankle weight high')." The thigh stays on the bench; only the lower leg travels. The left leg hangs still. ".$academia],

    'Abdução em pé com elástico' => ['cena' => 'He stands upright holding a steel post with his left hand for balance. The CAMERA IS DIRECTLY IN FRONT OF HIM: his chest, both shoulders and his face turn toward the lens in every frame, never in profile. A thick RED elastic loop band is stretched around BOTH ankles, connecting them. His torso stays upright and the working right knee stays locked STRAIGHT, the whole leg rigid like a pole: the knee NEVER bends and never comes up in front of him. '.sprintf($duasPosicoes, 'both feet are together on the floor, the band slack between the ankles', 'the whole right leg has been lifted far OUT to his right side, straight as a pole, the foot as high as his other knee, the band stretched long and taut between the ankles')." On the screen, the working foot travels ACROSS the picture toward the right edge and back, always at the same distance from the camera: it never swings forward and never backward behind him. ".$academia],

    'Deslocamento lateral com miniband' => ['cena' => 'He is in a half squat, knees bent and hips back, hands clasped in front of his chest, filmed from the FRONT. '.$miniband.' He WALKS SIDEWAYS across the gym floor: the camera sees him travel from the LEFT side of the frame toward the RIGHT side, one step at a time. With each step his right foot reaches wide out to the right, stretching the band, and then the left foot follows, never closing completely, so his feet are always at least shoulder width apart. He stays low in the half squat the whole time and never stands up. Two small bright ORANGE traffic cones stand on the floor about three metres apart: one near the LEFT edge of the picture and one near the RIGHT edge. In the first frame he is standing right beside the LEFT cone; with four side steps he travels across the floor, and in the last frame he is standing right beside the RIGHT cone. The camera does not move and the cones stay fixed in the picture, so his journey from one cone to the other is obvious. It is a WALK, never a squat on the spot and never stepping in place. '.$academia],

    'Glúteo coice com caneleira' => ['execucao' => 'Em quatro apoios sobre o colchonete, apoiado nos antebraços (cotovelos flexionados), com a caneleira no tornozelo: leve a perna para trás e para cima.', 'cena' => 'He kneels on all fours on a thick blue EXERCISE MAT lying on the gym floor, filmed from the SIDE. He rests on his FOREARMS, not his hands: both elbows are BENT at a right angle and the forearms lie flat on the mat under his shoulders. One padded ANKLE WEIGHT is strapped clearly around his right ankle. His left knee stays on the mat. '.sprintf($duasPosicoes, 'the right knee is tucked forward under his hips, close to the mat', 'the right leg has been driven BACK and UP, knee bent to a right angle, the sole of the foot pressed up toward the ceiling, the thigh lifted above the line of his back')." His HANDS are never flat on the mat and his arms are never straight: his elbows and forearms rest on the mat, so his chest and shoulders are LOW, close to the mat, lower than his hips. The mat and the ankle weight are visible in every frame. ".$academia],

    'Elevação de quadril no smith' => ['cena' => 'He sits on the floor inside a SMITH MACHINE with a FLAT BENCH standing crosswise behind him: his UPPER BACK and shoulder blades rest on the long edge of that bench, and his body lies across it at a right angle, like a T. The guided smith bar lies across the crease of his hips, padded, held by both hands. His feet are flat on the floor, knees bent. There is always a bench under his shoulder blades; he never lies flat on the floor, and he is NEVER sitting on top of the bench: only his shoulder blades touch its edge, and in the start position his buttocks are down near the FLOOR, below the bench. '.sprintf($duasPosicoes, 'his hips are dropped LOW toward the floor, well below the bench edge', 'his hips are driven UP until his shoulders, hips and knees form one straight horizontal line level with the bench, pushing the bar up with them')." ".$academia],

    'Subida no step com halter' => ['cena' => 'He holds ONE dumbbell in EACH hand, arms hanging at his sides, filmed from the SIDE, in front of a high sturdy plyometric box. He places his WHOLE right FOOT flat on top of the box: the entire sole, from the toes to the HEEL, rests on the box top, and the heel never hangs off the edge. '.sprintf($duasPosicoes, 'the right foot is flat on the box and the left foot is on the floor, his body low', 'he has driven up through the right heel and stands tall ON the box, the right leg straight, the left foot brought up beside it')." ".$academia],

    'Roda abdominal ajoelhado' => ['cena' => 'He kneels on the gym floor, filmed from the SIDE, gripping the two handles of an AB WHEEL — one small wheel with a handle sticking out on each side. '.sprintf($duasPosicoes, 'the wheel is on the floor right under his shoulders, his hips high and his body folded, arms straight', 'he has rolled the wheel far FORWARD until his arms are stretched out ahead of his head and his whole body is long and LOW, almost parallel with the floor from knees to hands, the back flat')." The rollout travels far, most of the length of his body, never a small push. His knees stay on the floor. The wheel NEVER leaves the floor: it rolls along the ground the entire time and is never lifted into the air, never raised in front of his face and never held overhead. ".$academia],

    'Rollout na barra' => ['cena' => 'He kneels on the gym floor, filmed from the SIDE, gripping a loaded barbell that rests on its round weight plates in front of his knees, so the bar can roll. '.sprintf($duasPosicoes, 'the bar is under his shoulders, arms straight, hips high and body folded', 'he has rolled the bar far FORWARD until his arms are stretched out ahead of his head and his whole body is long and LOW, almost parallel with the floor from knees to hands, the back flat')." The rollout travels far, never a small push. His knees stay on the floor. The weight plates NEVER leave the floor: the bar rolls along the ground the entire time and is never lifted into the air, never pressed up and never held overhead. ".$academia],

    'Bicicleta ergométrica' => ['cena' => 'He rides a classic UPRIGHT STATIONARY EXERCISE BIKE of the kind found in a cardio room: a smooth enclosed plastic body, a padded saddle, FIXED curved handlebars with a small digital console screen between them, and pedals. The whole front of the bike is a closed smooth shell with no wheel or spokes visible. It is NEVER an air bike: there is no large fan wheel, no cage of fan blades and no moving arm handles, and his arms never push or pull. He sits on the saddle with his hands resting on the fixed handlebars and pedals steadily, his legs going round in full circles while his upper body stays still. Filmed from the side. '.$academia],
];

return array_replace($base, $maquinas, $outras, $complementar, $revisaoNumerada, $revisaoHugo, $revisaoHugoMaquinas, $terceiraPassada, $revisaoHugoHalteres, $revisaoHugoCorpo, $revisaoHugoCore, $revisaoHugoPolia, $revisaoHugoPesoLivre, $revisaoHugoMistos);
