...
$revisaoHugoCorpo = [
    ...
    'Elevação pélvica com perna estendida' => ['cena' => 'He lies flat on his back on the gym floor, arms out at his sides for balance. ONE foot is planted flat on the floor with that knee bent; the OTHER leg is lifted and held completely STRAIGHT, pointing up at the ceiling, and it never lowers or bends. '.sprintf($duasPosicoes, 'his hips are resting DOWN on the floor, buttocks touching the ground', 'his hips are driven HIGH so that shoulders, hips and the planted knee form one straight line, glutes squeezed, with the free leg still pointing straight up').' '.$academia],
    ...
    'Ponte de glúteo no solo' => ['cena' => 'He lies flat on his back on the gym floor, both knees bent with both feet flat on the ground close to his buttocks, arms resting at his sides. '.sprintf($duasPosicoes, 'his hips and buttocks are resting DOWN on the floor, touching the ground', 'his hips are driven HIGH so that shoulders, hips and knees form one straight line, the body lifted well clear of the floor and the glutes squeezed hard').' The hips travel a long way, never a small twitch. '.$academia],
...
$revisaoHugoCore = [
    ...
    'Elevação de joelhos suspenso' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' '.sprintf($duasPosicoes, 'both legs hang straight down below him, relaxed', 'both KNEES are pulled up HIGH, above the level of his hips and close to his chest, thighs past horizontal and knees bent')." His torso stays still under the bar without swinging. ".$academia],

    'Elevação de pernas suspenso na barra' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' '.sprintf($duasPosicoes, 'both legs hang straight down below him', 'both legs are raised together, knees LOCKED STRAIGHT, up to HORIZONTAL, forming an L shape with his torso, toes pointing forward at the camera')." The knees never bend and the feet never go up to touch the bar. ".$academia],
    ...
    'Limpador de para-brisa suspenso na barra' => ['cena' => 'He hangs from a fixed PULL-UP BAR high above him, arms straight, feet off the floor. '.$pegadaBarra.' Both legs are straight and together and are raised HIGH, pointing UP toward the bar, so his body is folded in a tight pike with the feet up near the level of his hands. The legs NEVER hang down low. '.sprintf($duasPosicoes, 'the raised straight legs are swung far over to his LEFT side, feet high', 'the raised straight legs are swung far over to his RIGHT side, feet still high')." The feet sweep a wide arc over the top, like a windscreen wiper, and stay high the whole time: halfway through each sweep the feet pass straight UP near the bar between his hands. At NO moment do his legs drop down to hang below him, and he never returns to a straight dead hang between sweeps. ".$academia],
