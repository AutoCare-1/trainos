...
$poliaNaAltura = 'A single steel cable runs horizontally from his hand to a pulley wheel fixed at the side of the tower at the height of his own ELBOW, so the cable is level with his forearm and pulls him sideways. Nothing hangs above his head: no cable and no pulley appears higher than his shoulder, and the top of the tower is bare.';
...
$revisaoHugoPolia = [
    ...
    'Face pull' => ['cena' => $deFrente.' '.$corda.' The rope hangs from a single pulley wheel fixed HIGH on the tower, slightly above the top of his head, and the cable runs from the rope up to it. '.sprintf($duasPosicoes, 'both arms are stretched straight out in FRONT of him at eye level, the rope pulled long and the hands together far away from his face', 'both hands have been pulled back to each side of his FACE, level with his ears, the two rope ends passing on either side of his head, with both ELBOWS lifted HIGH and flared far out to the sides, level with his shoulders or above them').' The hands finish beside his face, never down at his chest and never at his belly, and the elbows are always higher than his wrists. '.$academia],

    'Puxada frontal pegada neutra' => ['cena' => $bancoPulldown.' The attachment is a SHORT PARALLEL-GRIP handle: two straight grips mounted side by side pointing toward him, about two hand widths apart, so that both PALMS FACE EACH OTHER with the thumbs up, hands close together above his head. It is never a long wide straight lat bar, never an angled bar, and his hands are never wider apart than his own shoulders. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, shoulders pulled up beside his ears, the handle high near the pulley', 'the handle has been pulled all the way DOWN to touch the top of his CHEST, both elbows folded and driven down close beside his ribs, chest lifted and shoulder blades squeezed together').' '.$cabo.' '.$academia],

    'Puxada frontal pegada supinada' => ['cena' => $bancoPulldown.' He holds a short straight cable bar with an UNDERHAND grip, hands about shoulder width apart, and the camera in front of him sees it clearly: it sees the pale INNER side of both forearms and the biceps turned toward the lens, while the backs of his hands and his knuckles are hidden, curled away on the far side of the bar. His palms face up toward the ceiling and toward his own face the whole time, never down and never forward. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, the bar high near the pulley', 'the bar has been pulled all the way DOWN to the top of his CHEST, both elbows folded and pointing down close beside his ribs').' '.$cabo.' '.$academia],

    'Puxador triângulo' => ['cena' => $bancoPulldown.' The attachment is a small solid TRIANGLE of steel, about the size of a dinner plate, hanging point-up from the cable, with two short straight grips inside it, one for each hand. He grips those two inner handles with the PALMS FACING EACH OTHER, the two hands close together right in the middle above his head, knuckles of the two fists nearly touching. That triangle is never a long straight bar, never a wide lat bar, never a W or EZ bar, and it never grows wider than his own chest. '.sprintf($duasPosicoes, 'both arms are stretched completely straight UP above his head, the triangle high near the pulley', 'the triangle has been pulled all the way DOWN to touch the top of his CHEST, both elbows folded and driven down close beside his ribs, chest lifted').' '.$cabo.' '.$academia],
    ...
    'Abdução de quadril na polia' => ['cena' => 'He stands SIDE-ON to a cable tower, filmed from the front, the tower close to his LEFT side, and holds the frame with his left hand for balance. The working leg is his RIGHT leg, the one FARTHER from the tower, and the cable crosses low in front of his left shin to reach the cuff on his right ankle. '.$poliaTornozelo.' His torso stays upright and vertical over the standing foot the whole time, and the working knee stays locked STRAIGHT. '.sprintf($duasPosicoes, 'the right foot is down beside the left foot and slightly crossed in front of it, the legs almost touching', 'the whole right leg has been lifted far OUT to the right side, straight as a pole, the foot raised at least to the height of his other KNEE, wide away from his body').' It is a wide, obvious sweep of the leg, never a lift of a few centimetres, and his shoulders never tip over to the other side. '.$academia],

    'Adução de quadril na polia' => ['cena' => 'He stands SIDE-ON to a cable tower, filmed from the front, the tower close to his RIGHT side, and holds the frame with his right hand for balance. The working leg is his RIGHT leg, the one NEAREST the tower, so the cable pulls that leg out to the right. '.$poliaTornozelo.' His torso stays upright and vertical the whole time and the working knee stays locked STRAIGHT. '.sprintf($duasPosicoes, 'the right leg is out to the RIGHT side, away from his body and lifted off the floor toward the tower, knee straight', 'the same right leg has been pulled all the way ACROSS the midline of his body and passes IN FRONT of the standing left leg, the right foot finishing clearly on the left side of the standing foot, legs crossed like scissors').' It is a wide, obvious sweep across the body, never a small twitch beside the standing foot. '.$academia],
