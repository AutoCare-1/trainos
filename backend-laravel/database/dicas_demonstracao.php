...
$revisaoHugoCorpo = [
    ...
    'Barra fixa pegada supinada (chin-up)' => ['cena' => 'He hangs from a fixed horizontal PULL-UP BAR high above him, feet off the floor. His grip is UNDERHAND, and the camera in front of him sees it clearly: it sees the INNER face of both wrists and the soft pale underside of both forearms turned toward the lens, with the biceps bulging on the front of each arm. His fingernails and knuckles are HIDDEN from the camera, curled away over the far side of the bar, and the thumbs point outward away from each other. The camera never sees the backs of his hands: the backs of both hands, the knuckles and his wristwatch are all turned AWAY from the lens, toward the bar, and what the camera sees is the heel of each palm and the pale inside of each wrist. This is a chin-up, never a pull-up: his palms face HIS OWN FACE, never away from him, and his knuckles never face the camera. At the top his chin clearly rises ABOVE the bar. '.sprintf($duasPosicoes, 'both arms are completely straight, hanging at full stretch with the shoulders pulled up beside his ears', 'both elbows are folded shut and his CHIN is above the level of the bar, chest close to it, elbows pointing down beside his ribs').' '.$academia],
...
return array_replace($base, $maquinas, $outras, $complementar, $revisaoNumerada, $revisaoHugo, $revisaoHugoMaquinas, $terceiraPassada, $revisaoHugoHalteres, $revisaoHugoCorpo, $revisaoHugoCore, $revisaoHugoPolia, $revisaoHugoPesoLivre);
