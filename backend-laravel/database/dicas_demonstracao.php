...
$revisaoHugoCore = [
    ...
    'Abdominal declinado' => ['cena' => 'He lies face up on a dedicated DECLINE SIT-UP BENCH: a long narrow padded board on a steel frame, slanted steeply so the FEET end is high and the HEAD end is low near the floor. At the high end his ankles are hooked under two thick padded foot rollers that hold his legs in place, knees bent. It is never an ordinary flat or adjustable weight bench, and his head is always lower than his hips. His hands are crossed on his chest. '.sprintf($duasPosicoes, 'his back lies flat along the slanted board, head down at the low end, shoulders touching the pad', 'his torso has curled all the way UP until his chest is close to his thighs, back clear of the board').' '.$academia],
    ...
    'Hollow hold' => ['estatico' => true, 'execucao' => 'Deitado de barriga para cima, lombar colada no chão, braços estendidos atrás da cabeça e pernas estendidas alguns centímetros acima do solo.', 'cena' => 'He lies on his back on the gym floor, filmed from the SIDE, in a hollow body hold. His lower back stays pressed flat into the floor. Both arms are stretched straight BACK past his head, biceps beside his ears, hands hovering LOW just above the floor behind him. Both legs are straight and together, lifted only a LITTLE: his heels hover LOW, just a hand width above the floor, never pointing up at the ceiling. His head and shoulder blades are lifted slightly off the floor. The whole body forms a long, shallow banana curve. It is an isometric hold: he stays in this position, breathing, with the body trembling slightly from the effort, never sitting up. '.$academia],

    'Hollow rock' => ['cena' => 'He lies on his back on the gym floor, filmed from the SIDE, in a hollow body position: arms stretched straight back past his head beside his ears, legs straight and together, both arms and legs held LOW, only a little above the floor, the body a long shallow banana curve. He is never in a V-sit with arms and legs pointing up at the ceiling. '.sprintf($duasPosicoes, 'he has rocked BACK: his upper back touches the floor and his feet have risen a little higher', 'he has rocked FORWARD: his lower back and buttocks touch the floor and his hands have risen a little while his heels come close to the floor')." He rocks back and forth like a rocking chair while keeping the same rigid banana shape. ".$academia],
