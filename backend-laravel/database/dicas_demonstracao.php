...
$revisaoHugoPolia = [
    ...
    'Abdução de quadril na polia' => ['cena' => 'He stands with a cable tower close to his LEFT side and holds its frame with his left hand for balance. The CAMERA IS DIRECTLY IN FRONT OF HIM and stays there: his chest, both shoulders and his face are turned toward the lens in every single frame, and he is NEVER seen in profile, never side-on to the camera and never from behind. The tower stands beside him, at the edge of the frame.  The working leg is his RIGHT leg, the one FARTHER from the tower, and the cable crosses low in front of his left shin to reach the cuff on his right ankle. '.$poliaTornozelo.' His torso stays upright and vertical over the standing foot the whole time, and the working knee stays locked STRAIGHT. '.sprintf($duasPosicoes, 'the right foot is down beside the left foot and slightly crossed in front of it, the legs almost touching', 'the whole right leg has been lifted far OUT to the right side, straight as a pole, the foot raised at least to the height of his other KNEE, wide away from his body').' On the screen, the working foot travels ACROSS the picture, sliding sideways from the middle of the frame toward its RIGHT edge and back, always at the same distance from the camera. It NEVER travels toward the camera, never away from it, never forward in front of his body and never backward behind him: the knee never comes up in front of his belly and the foot never ends up behind the standing heel. This is never a forward knee raise, never a backward kick and never a glute kickback. The gap between his two feet opens wide and obvious, like a compass opening. His shoulders never tip over to the other side. '.$academia],

    'Adução de quadril na polia' => ['cena' => 'He stands with a cable tower close to his RIGHT side and holds its frame with his right hand for balance. The CAMERA IS DIRECTLY IN FRONT OF HIM and stays there: his chest, both shoulders and his face are turned toward the lens in every single frame, and he is NEVER seen in profile, never side-on to the camera and never from behind. The tower stands beside him, at the edge of the frame.  The working leg is his RIGHT leg, the one NEAREST the tower, so the cable pulls that leg out to the right. '.$poliaTornozelo.' His torso stays upright and vertical the whole time and the working knee stays locked STRAIGHT. '.sprintf($duasPosicoes, 'the right leg is out to the RIGHT side, away from his body and lifted off the floor toward the tower, knee straight', 'the same right leg has been pulled all the way ACROSS the midline of his body and passes IN FRONT of the standing left leg, the right foot finishing clearly on the left side of the standing foot, legs crossed like scissors').' On the screen, the working foot travels ACROSS the picture, sliding sideways from the RIGHT edge of the frame toward the middle and past it, always at the same distance from the camera. It NEVER travels toward the camera, never away from it, never forward in front of his body and never backward behind him: the knee never comes up in front of his belly and the foot never ends up behind the standing heel. This is never a forward knee raise, never a backward kick and never a glute kickback. The two legs finish visibly crossed, like a pair of scissors. '.$academia],
