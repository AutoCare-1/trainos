...
/**
 * Espelha backend/src/services/conteudoAgregados.ts do Node.
 *
 ...
 */
class ConteudoAgregados
{
    public static function montarResumoAgregadoAlunos(string $professionalId): string
    {
        $totalAlunos = (int) DB::table('students')->where('professional_id', $professionalId)->count();
