      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="mx-auto w-full max-w-lg flex-1 px-4 py-6">
          ...
          <div className="glass mb-4 rounded-2xl p-5">
            ...
            <p className="mb-4 text-sm text-ink-muted">
              Uma foto já basta, e é só do dia de hoje. Amanhã essa lista começa
              limpa — mas seu professor continua vendo os últimos dias pra te
              orientar.
            </p>
              ...
              <div className="mb-2 max-h-52 overflow-y-auto rounded-xl border border-line">
                ...
                {resultadosAlimento
                  ...
                  .map((a) => (
                    ...
                    >
                      {/* line-clamp e não truncate: os nomes da POF trazem as
                          variedades entre parênteses ("Arroz (polido,
                          parboilizado, ...)") e numa linha só o aluno lê
                          "Arroz (polido, parboiliz..." e não sabe o que é. */}
                      <span className="min-w-0 flex-1 line-clamp-2 text-sm text-ink-soft">{a.nome}</span>
